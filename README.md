# ESP-It
ESP cheat for Witch It, currently compatible with the latest version 1.6.0.3 (23234) for both the Steam and Epic Games version. Renders the player name above every player - including props/witches.
