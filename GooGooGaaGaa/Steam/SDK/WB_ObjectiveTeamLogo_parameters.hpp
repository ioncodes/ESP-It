...
struct WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0 final
{
public:
...
static_assert(sizeof(WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0) == 0x0001D0, "Wrong size on WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0");
static_assert(offsetof(WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0, ReturnValue) == 0x000000, "Member 'WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0::ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0, Temp_byte_Variable) == 0x0000D0, "Member 'WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0, Temp_object_Variable) == 0x0000D8, "Member 'WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0, Temp_object_Variable_1) == 0x0000E0, "Member 'WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0::Temp_object_Variable_1' has a wrong offset!");
static_assert(offsetof(WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0, Temp_object_Variable_2) == 0x0000E8, "Member 'WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0::Temp_object_Variable_2' has a wrong offset!");
static_assert(offsetof(WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0, K2Node_Select_Default) == 0x0000F0, "Member 'WB_ObjectiveTeamLogo_C_Get_Logo_Brush_0::K2Node_Select_Default' has a wrong offset!");
