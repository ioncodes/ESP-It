...
static_assert(sizeof(WB_CameraScreen_C_Get_Title_Text_0) == 0x000158, "Wrong size on WB_CameraScreen_C_Get_Title_Text_0");
...
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, Temp_bool_Variable) == 0x000010, "Member 'WB_CameraScreen_C_Get_Title_Text_0::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, Temp_text_Variable) == 0x000018, "Member 'WB_CameraScreen_C_Get_Title_Text_0::Temp_text_Variable' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, CallFunc_Conv_IntToInt64_ReturnValue) == 0x000028, "Member 'WB_CameraScreen_C_Get_Title_Text_0::CallFunc_Conv_IntToInt64_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, K2Node_MakeStruct_FormatArgumentData) == 0x000030, "Member 'WB_CameraScreen_C_Get_Title_Text_0::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, CallFunc_GetPlayerName_ReturnValue) == 0x000078, "Member 'WB_CameraScreen_C_Get_Title_Text_0::CallFunc_GetPlayerName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, K2Node_MakeArray_Array) == 0x000088, "Member 'WB_CameraScreen_C_Get_Title_Text_0::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, CallFunc_Conv_StringToText_ReturnValue) == 0x000098, "Member 'WB_CameraScreen_C_Get_Title_Text_0::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, CallFunc_Format_ReturnValue) == 0x0000A8, "Member 'WB_CameraScreen_C_Get_Title_Text_0::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, K2Node_MakeStruct_FormatArgumentData_1) == 0x0000B8, "Member 'WB_CameraScreen_C_Get_Title_Text_0::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, K2Node_MakeArray_Array_1) == 0x000100, "Member 'WB_CameraScreen_C_Get_Title_Text_0::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, CallFunc_Format_ReturnValue_1) == 0x000110, "Member 'WB_CameraScreen_C_Get_Title_Text_0::CallFunc_Format_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, CallFunc_IsValid_ReturnValue) == 0x000120, "Member 'WB_CameraScreen_C_Get_Title_Text_0::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, CallFunc_GetGameInstance_ReturnValue) == 0x000128, "Member 'WB_CameraScreen_C_Get_Title_Text_0::CallFunc_GetGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, CallFunc_GetFirstLocalPlayerController_ReturnValue) == 0x000130, "Member 'WB_CameraScreen_C_Get_Title_Text_0::CallFunc_GetFirstLocalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, K2Node_DynamicCast_AsB_Impostor_Player_State) == 0x000138, "Member 'WB_CameraScreen_C_Get_Title_Text_0::K2Node_DynamicCast_AsB_Impostor_Player_State' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, K2Node_DynamicCast_bSuccess) == 0x000140, "Member 'WB_CameraScreen_C_Get_Title_Text_0::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, K2Node_SwitchEnum_CmpSuccess) == 0x000141, "Member 'WB_CameraScreen_C_Get_Title_Text_0::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WB_CameraScreen_C_Get_Title_Text_0, K2Node_Select_Default) == 0x000148, "Member 'WB_CameraScreen_C_Get_Title_Text_0::K2Node_Select_Default' has a wrong offset!");
