...
struct WB_CreativeHUD_C_UpdateMovementSpeedIndicator final
{
public:
	double                                        MovementSpeed;                                     // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(WB_CreativeHUD_C_UpdateMovementSpeedIndicator) == 0x000008, "Wrong alignment on WB_CreativeHUD_C_UpdateMovementSpeedIndicator");
static_assert(sizeof(WB_CreativeHUD_C_UpdateMovementSpeedIndicator) == 0x000088, "Wrong size on WB_CreativeHUD_C_UpdateMovementSpeedIndicator");
static_assert(offsetof(WB_CreativeHUD_C_UpdateMovementSpeedIndicator, MovementSpeed) == 0x000000, "Member 'WB_CreativeHUD_C_UpdateMovementSpeedIndicator::MovementSpeed' has a wrong offset!");
static_assert(offsetof(WB_CreativeHUD_C_UpdateMovementSpeedIndicator, CallFunc_Conv_DoubleToText_ReturnValue) == 0x000008, "Member 'WB_CreativeHUD_C_UpdateMovementSpeedIndicator::CallFunc_Conv_DoubleToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_CreativeHUD_C_UpdateMovementSpeedIndicator, CallFunc_PlayAnimation_ReturnValue) == 0x000018, "Member 'WB_CreativeHUD_C_UpdateMovementSpeedIndicator::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_CreativeHUD_C_UpdateMovementSpeedIndicator, K2Node_MakeStruct_FormatArgumentData) == 0x000020, "Member 'WB_CreativeHUD_C_UpdateMovementSpeedIndicator::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WB_CreativeHUD_C_UpdateMovementSpeedIndicator, K2Node_MakeArray_Array) == 0x000068, "Member 'WB_CreativeHUD_C_UpdateMovementSpeedIndicator::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WB_CreativeHUD_C_UpdateMovementSpeedIndicator, CallFunc_Format_ReturnValue) == 0x000078, "Member 'WB_CreativeHUD_C_UpdateMovementSpeedIndicator::CallFunc_Format_ReturnValue' has a wrong offset!");
