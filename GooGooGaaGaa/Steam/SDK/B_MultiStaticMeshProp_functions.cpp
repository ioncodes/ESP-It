...
void AB_MultiStaticMeshProp_C::SetPhysicsEnabled(bool bIsEnabled)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_MultiStaticMeshProp_C", "SetPhysicsEnabled");

	Params::B_MultiStaticMeshProp_C_SetPhysicsEnabled Parms{};
...
void AB_MultiStaticMeshProp_C::WakeFromSleep()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_MultiStaticMeshProp_C", "WakeFromSleep");
