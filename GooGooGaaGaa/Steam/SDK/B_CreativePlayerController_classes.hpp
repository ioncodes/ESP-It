...
public:
	...
	struct FVector                                GizmoHitLocation;                                  // 0x0D08(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<struct FS_SelectedActors>              NumberedSelections;                                // 0x0D20(0x0010)(Edit, BlueprintVisible, Net, DisableEditOnInstance)
	int32                                         SelectedNumberedGroup;                             // 0x0D30(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void DeselectMultipleActors(TArray<class AActor*>& ActorsToDeselect);
	...
	void FixNumberedSelectionsAfterDuplicate(const TMap<class AActor*, class AActor*>& DuplicatedActors);
	...
	void GetTranslationFromCurrentMode(class AActor* EditingActor, struct FVector* Translation);
	void Handle_Mouse_Wheel_Axis(double Axis);
	void HandleDelete();
	...
	void InpActEvt_Action_K2Node_InputActionEvent_2(const struct FKey& Key);
	void InpActEvt_ActivateUtilitySkill_K2Node_InputActionEvent_8(const struct FKey& Key);
	void InpActEvt_Delete_K2Node_InputKeyEvent_22(const struct FKey& Key);
	void InpActEvt_DragRightMouseButton_K2Node_InputActionEvent_3(const struct FKey& Key);
	void InpActEvt_DragRightMouseButton_K2Node_InputActionEvent_4(const struct FKey& Key);
	...
	void InpActEvt_F5_K2Node_InputKeyEvent_0(const struct FKey& Key);
	...
	void InpActEvt_Four_K2Node_InputKeyEvent_13(const struct FKey& Key);
	void InpActEvt_LeftAlt_K2Node_InputKeyEvent_16(const struct FKey& Key);
	void InpActEvt_LeftAlt_K2Node_InputKeyEvent_17(const struct FKey& Key);
	void InpActEvt_LeftShift_K2Node_InputKeyEvent_20(const struct FKey& Key);
	void InpActEvt_LeftShift_K2Node_InputKeyEvent_21(const struct FKey& Key);
	void InpActEvt_Menu_K2Node_InputActionEvent_7(const struct FKey& Key);
	void InpActEvt_MiddleMouseButton_K2Node_InputKeyEvent_19(const struct FKey& Key);
	void InpActEvt_Nine_K2Node_InputKeyEvent_4(const struct FKey& Key);
	void InpActEvt_One_K2Node_InputKeyEvent_9(const struct FKey& Key);
	void InpActEvt_PlayerList_K2Node_InputActionEvent_5(const struct FKey& Key);
	void InpActEvt_PlayerList_K2Node_InputActionEvent_6(const struct FKey& Key);
	void InpActEvt_R_K2Node_InputKeyEvent_18(const struct FKey& Key);
	void InpActEvt_RightAlt_K2Node_InputKeyEvent_14(const struct FKey& Key);
	void InpActEvt_RightAlt_K2Node_InputKeyEvent_15(const struct FKey& Key);
	void InpActEvt_Seven_K2Node_InputKeyEvent_6(const struct FKey& Key);
	...
	void InpActEvt_TypeTeamChatMessage_K2Node_InputActionEvent_1(const struct FKey& Key);
	...
	void NumberPressed(int32 Number);
	void OpenEditUi();
	void OpenTabScreen(bool IsPlayTest, bool IsRequiredScreen);
	void PlaceActor(class UClass* ActorClass, const struct FTransform& SpawnTransform, bool HasPrefabInfo, bool Activated, bool StartAwake, bool IsFreezed, bool BreaksAfterUse, const struct FVector& Color, TArray<uint8>& MaterialIndices, class AActor** NewPlacedActor);
	...
	void SaveNumberedSelectionServer(const TArray<class AActor*>& Actors, int32 Number);
...
static_assert(sizeof(AB_CreativePlayerController_C) == 0x000D38, "Wrong size on AB_CreativePlayerController_C");
...
static_assert(offsetof(AB_CreativePlayerController_C, GizmoHitLocation) == 0x000D08, "Member 'AB_CreativePlayerController_C::GizmoHitLocation' has a wrong offset!");
static_assert(offsetof(AB_CreativePlayerController_C, NumberedSelections) == 0x000D20, "Member 'AB_CreativePlayerController_C::NumberedSelections' has a wrong offset!");
static_assert(offsetof(AB_CreativePlayerController_C, SelectedNumberedGroup) == 0x000D30, "Member 'AB_CreativePlayerController_C::SelectedNumberedGroup' has a wrong offset!");
