...
public:
	...
	class UWB_IngameSkinConfigMenu_C*             HunterSkinConfigSelection;                         // 0x0300(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UTextBlock*                             MinimumPlayersText;                                // 0x0310(0x0008)(ExportObject, ZeroConstructor, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UTextBlock*                             PlayersText;                                       // 0x0318(0x0008)(ExportObject, ZeroConstructor, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWB_Button_C*                           Ready;                                             // 0x0320(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWB_Button_C*                           SpectatorReady;                                    // 0x0328(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(offsetof(UWB_ImpostorTeamSelectionScreen_C, GameNameText) == 0x0002F8, "Member 'UWB_ImpostorTeamSelectionScreen_C::GameNameText' has a wrong offset!");
static_assert(offsetof(UWB_ImpostorTeamSelectionScreen_C, HunterSkinConfigSelection) == 0x000300, "Member 'UWB_ImpostorTeamSelectionScreen_C::HunterSkinConfigSelection' has a wrong offset!");
static_assert(offsetof(UWB_ImpostorTeamSelectionScreen_C, Menu) == 0x000308, "Member 'UWB_ImpostorTeamSelectionScreen_C::Menu' has a wrong offset!");
static_assert(offsetof(UWB_ImpostorTeamSelectionScreen_C, MinimumPlayersText) == 0x000310, "Member 'UWB_ImpostorTeamSelectionScreen_C::MinimumPlayersText' has a wrong offset!");
static_assert(offsetof(UWB_ImpostorTeamSelectionScreen_C, PlayersText) == 0x000318, "Member 'UWB_ImpostorTeamSelectionScreen_C::PlayersText' has a wrong offset!");
static_assert(offsetof(UWB_ImpostorTeamSelectionScreen_C, Ready) == 0x000320, "Member 'UWB_ImpostorTeamSelectionScreen_C::Ready' has a wrong offset!");
static_assert(offsetof(UWB_ImpostorTeamSelectionScreen_C, SpectatorReady) == 0x000328, "Member 'UWB_ImpostorTeamSelectionScreen_C::SpectatorReady' has a wrong offset!");
