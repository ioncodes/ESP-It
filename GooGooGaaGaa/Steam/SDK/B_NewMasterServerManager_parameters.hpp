...
public:
	...
	struct FUniqueNetIdRepl                       CallFunc_GetUniqueNetIdForFirstLocalPC_UniqueNetId; // 0x0290(0x0030)(HasGetValueTypeHash)
...
static_assert(offsetof(B_NewMasterServerManager_C_ExecuteUbergraph_B_NewMasterServerManager, CallFunc_GetUniqueNetIdForFirstLocalPC_UniqueNetId) == 0x000290, "Member 'B_NewMasterServerManager_C_ExecuteUbergraph_B_NewMasterServerManager::CallFunc_GetUniqueNetIdForFirstLocalPC_UniqueNetId' has a wrong offset!");
static_assert(offsetof(B_NewMasterServerManager_C_ExecuteUbergraph_B_NewMasterServerManager, CallFunc_Concat_StrStr_ReturnValue) == 0x0002C0, "Member 'B_NewMasterServerManager_C_ExecuteUbergraph_B_NewMasterServerManager::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
