...
void AB_GameMode_C::SpawnPlaceableStatic(class UClass* Class_0, const struct FTransform& Transform, TArray<uint8>& MaterialIndices, class ABP_PlaceableStaticProp_C** SpawnedActor)
{
	static class UFunction* Func = nullptr;
...
void AB_GameMode_C::SpawnActionPlaceableStatic(class UClass* Class_0, const struct FTransform& Transform, bool Activated, TArray<uint8>& MaterialIndices, class ABP_PlaceableStaticProp_C** SpawnedActor)
{
	static class UFunction* Func = nullptr;
...
// bool                                    IsPSNUser                                              (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_GameMode_C::GetPlayerIdForMatch(class APlayerState* PlayerState, struct FUniqueNetIdRepl* NetId, bool* IsPSNUser)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_GameMode_C", "GetPlayerIdForMatch");

	Params::B_GameMode_C_GetPlayerIdForMatch Parms{};
	...
	if (IsPSNUser != nullptr)
		*IsPSNUser = Parms.IsPSNUser;
}
...
void AB_GameMode_C::SetupMatchStartDetails()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_GameMode_C", "SetupMatchStartDetails");
...
void AB_GameMode_C::CreateOnlineMatch()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_GameMode_C", "CreateOnlineMatch");
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APlayerController*                SourcePlayer                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void AB_GameMode_C::SendPlayerJoinedMessageToAll(class APlayerController* SourcePlayer)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_GameMode_C", "SendPlayerJoinedMessageToAll");

	Params::B_GameMode_C_SendPlayerJoinedMessageToAll Parms{};
...
void AB_GameMode_C::HandlePlayerLeft(class AB_PlayerController_C* PlayerController)
{
	static class UFunction* Func = nullptr;
