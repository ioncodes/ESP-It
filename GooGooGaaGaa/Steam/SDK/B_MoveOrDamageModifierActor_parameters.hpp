...
public:
	...
	bool                                          CallFunc_IsRoundEnd_RoundIsEnd;                    // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_TickAllPlayersDamage_DeltaSeconds_ImplicitCast; // 0x0060(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor) == 0x000068, "Wrong size on B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor");
...
static_assert(offsetof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor, CallFunc_GetGameMode_ReturnValue) == 0x000008, "Member 'B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor::CallFunc_GetGameMode_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor, K2Node_DynamicCast_AsB_Game_Mode) == 0x000010, "Member 'B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor::K2Node_DynamicCast_AsB_Game_Mode' has a wrong offset!");
static_assert(offsetof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor, K2Node_Event_DeltaSeconds) == 0x00001C, "Member 'B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor, CallFunc_GetGameState_ReturnValue) == 0x000020, "Member 'B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor::CallFunc_GetGameState_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor, K2Node_DynamicCast_AsB_Seek_Game_State) == 0x000028, "Member 'B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor::K2Node_DynamicCast_AsB_Seek_Game_State' has a wrong offset!");
static_assert(offsetof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor, K2Node_DynamicCast_bSuccess_1) == 0x000030, "Member 'B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor, K2Node_CreateDelegate_OutputDelegate) == 0x000034, "Member 'B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000044, "Member 'B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor, K2Node_CreateDelegate_OutputDelegate_1) == 0x000048, "Member 'B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor, CallFunc_IsRoundEnd_RoundIsEnd) == 0x000058, "Member 'B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor::CallFunc_IsRoundEnd_RoundIsEnd' has a wrong offset!");
static_assert(offsetof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor, CallFunc_Not_PreBool_ReturnValue) == 0x000059, "Member 'B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor, CallFunc_TickAllPlayersDamage_DeltaSeconds_ImplicitCast) == 0x000060, "Member 'B_MoveOrDamageModifierActor_C_ExecuteUbergraph_B_MoveOrDamageModifierActor::CallFunc_TickAllPlayersDamage_DeltaSeconds_ImplicitCast' has a wrong offset!");
