...
public:
	...
	bool                                          CallFunc_Not_PreBool_ReturnValue_1;                // 0x00ED(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsAnimationPlaying_ReturnValue;           // 0x00EE(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Not_PreBool_ReturnValue_2;                // 0x00EF(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetAnimationCurrentTime_ReturnValue;      // 0x00F0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry, CallFunc_Not_PreBool_ReturnValue) == 0x000004, "Member 'WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry, CallFunc_MakeLiteralInt_ReturnValue) == 0x000058, "Member 'WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry::CallFunc_MakeLiteralInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry, CallFunc_Conv_IntToDouble_ReturnValue) == 0x000060, "Member 'WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry, K2Node_MakeStruct_LinearColor) == 0x000068, "Member 'WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry::K2Node_MakeStruct_LinearColor' has a wrong offset!");
static_assert(offsetof(WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry, K2Node_MakeStruct_SlateFontInfo) == 0x000078, "Member 'WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry::K2Node_MakeStruct_SlateFontInfo' has a wrong offset!");
static_assert(offsetof(WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry, K2Node_MakeStruct_SlateColor) == 0x0000D8, "Member 'WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry::K2Node_MakeStruct_SlateColor' has a wrong offset!");
static_assert(offsetof(WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry, CallFunc_IsValid_ReturnValue) == 0x0000EC, "Member 'WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry, CallFunc_Not_PreBool_ReturnValue_1) == 0x0000ED, "Member 'WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry, CallFunc_IsAnimationPlaying_ReturnValue) == 0x0000EE, "Member 'WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry::CallFunc_IsAnimationPlaying_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry, CallFunc_Not_PreBool_ReturnValue_2) == 0x0000EF, "Member 'WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry::CallFunc_Not_PreBool_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry, CallFunc_GetAnimationCurrentTime_ReturnValue) == 0x0000F0, "Member 'WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry::CallFunc_GetAnimationCurrentTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry, CallFunc_BooleanAND_ReturnValue) == 0x0000F4, "Member 'WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry, CallFunc_PlayAnimation_ReturnValue) == 0x0000F8, "Member 'WB_ChatEntry_C_ExecuteUbergraph_WB_ChatEntry::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
