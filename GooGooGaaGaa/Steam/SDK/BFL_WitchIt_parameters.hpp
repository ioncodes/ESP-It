...
struct BFL_WitchIt_C_GetNativePlatformName final
{
public:
	...
	class FString                                 PlatformName;                                      // 0x0010(0x0010)(Parm, OutParm, ZeroConstructor, HasGetValueTypeHash)
...
static_assert(alignof(BFL_WitchIt_C_GetNativePlatformName) == 0x000008, "Wrong alignment on BFL_WitchIt_C_GetNativePlatformName");
static_assert(sizeof(BFL_WitchIt_C_GetNativePlatformName) == 0x000048, "Wrong size on BFL_WitchIt_C_GetNativePlatformName");
static_assert(offsetof(BFL_WitchIt_C_GetNativePlatformName, WorldContext) == 0x000000, "Member 'BFL_WitchIt_C_GetNativePlatformName::WorldContext' has a wrong offset!");
static_assert(offsetof(BFL_WitchIt_C_GetNativePlatformName, __WorldContext) == 0x000008, "Member 'BFL_WitchIt_C_GetNativePlatformName::__WorldContext' has a wrong offset!");
static_assert(offsetof(BFL_WitchIt_C_GetNativePlatformName, PlatformName) == 0x000010, "Member 'BFL_WitchIt_C_GetNativePlatformName::PlatformName' has a wrong offset!");
static_assert(offsetof(BFL_WitchIt_C_GetNativePlatformName, CallFunc_GetBGameInstance_ReturnValue) == 0x000020, "Member 'BFL_WitchIt_C_GetNativePlatformName::CallFunc_GetBGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_WitchIt_C_GetNativePlatformName, CallFunc_GetNativePlatformAccountName_NativePlatformId) == 0x000028, "Member 'BFL_WitchIt_C_GetNativePlatformName::CallFunc_GetNativePlatformAccountName_NativePlatformId' has a wrong offset!");
static_assert(offsetof(BFL_WitchIt_C_GetNativePlatformName, CallFunc_GetNativePlatformAccountName_NativePlatform) == 0x000038, "Member 'BFL_WitchIt_C_GetNativePlatformName::CallFunc_GetNativePlatformAccountName_NativePlatform' has a wrong offset!");
