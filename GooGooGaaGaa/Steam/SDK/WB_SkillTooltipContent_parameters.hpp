...
public:
	...
	bool                                          CallFunc_OpenUrl_ReturnValue;                      // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent) == 0x000080, "Wrong size on WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent");
...
static_assert(offsetof(WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent, CallFunc_SwitchPlatform_ReturnValue) == 0x000004, "Member 'WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent::CallFunc_SwitchPlatform_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent, Temp_bool_Variable) == 0x000005, "Member 'WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent, K2Node_Event_IsDesignTime) == 0x000006, "Member 'WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent::K2Node_Event_IsDesignTime' has a wrong offset!");
...
static_assert(offsetof(WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent, CallFunc_Split_LeftS) == 0x000020, "Member 'WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent::CallFunc_Split_LeftS' has a wrong offset!");
static_assert(offsetof(WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent, CallFunc_Split_RightS) == 0x000030, "Member 'WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent::CallFunc_Split_RightS' has a wrong offset!");
static_assert(offsetof(WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent, CallFunc_Split_ReturnValue) == 0x000040, "Member 'WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent::CallFunc_Split_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent, CallFunc_Concat_StrStr_ReturnValue) == 0x000048, "Member 'WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent, CallFunc_Concat_StrStr_ReturnValue_1) == 0x000058, "Member 'WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent::CallFunc_Concat_StrStr_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent, K2Node_Select_Default) == 0x000068, "Member 'WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent, CallFunc_OpenUrl_ReturnValue) == 0x000078, "Member 'WB_SkillTooltipContent_C_ExecuteUbergraph_WB_SkillTooltipContent::CallFunc_OpenUrl_ReturnValue' has a wrong offset!");
