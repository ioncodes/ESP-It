...
public:
	...
	bool                                          IsOutgoing;                                        // 0x0329(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Is_Blocked_Player;                                 // 0x032A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

public:
	void AcceptKeyPressed();
	void BlockPlayerAnswer(E_QuestionAnswer Answer);
...
static_assert(offsetof(UWB_OnlineUserEntry_C, IsOutgoing) == 0x000329, "Member 'UWB_OnlineUserEntry_C::IsOutgoing' has a wrong offset!");
static_assert(offsetof(UWB_OnlineUserEntry_C, Is_Blocked_Player) == 0x00032A, "Member 'UWB_OnlineUserEntry_C::Is_Blocked_Player' has a wrong offset!");
