...
struct B_ImpostorGameMode_C_SetupMatchStartDetails final
{
public:
	...
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FUniqueNetIdRepl>               HunterPlayers;                                     // 0x0008(0x0010)(Edit, BlueprintVisible)
	struct FUniqueNetIdRepl                       CurrentPlayerId;                                   // 0x0018(0x0030)(Edit, BlueprintVisible, HasGetValueTypeHash)
	TArray<struct FMatchPlayer>                   PlayersToAdd;                                      // 0x0048(0x0010)(Edit, BlueprintVisible)
	class AB_PlayerState_C*                       CurrentPlayerState;                                // 0x0058(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	class UB_GameInstance_C*                      GameInstance;                                      // 0x0060(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FUniqueNetIdRepl                       CallFunc_GetPlayerIdForMatch_NetId;                // 0x00B8(0x0030)(HasGetValueTypeHash)
	bool                                          CallFunc_GetPlayerIdForMatch_IsPSNUser;            // 0x00E8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_E9[0x7];                                       // 0x00E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMatchTeam                             K2Node_MakeStruct_MatchTeam;                       // 0x00F0(0x0030)()
	TArray<struct FMatchTeam>                     K2Node_MakeArray_Array;                            // 0x0120(0x0010)(ConstParm, ReferenceParm)
	...
	struct FMatchPlayer                           K2Node_MakeStruct_MatchPlayer;                     // 0x0148(0x0058)()
	...
	class UOnlineIdentitySubsystem*               CallFunc_GetGameInstanceSubsystem_ReturnValue;     // 0x01A8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UMatchSubsystem*                        CallFunc_GetGameInstanceSubsystem_ReturnValue_1;   // 0x01B0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FUniqueNetIdRepl                       CallFunc_GetPlayerStateUniqueNetId_ReturnValue;    // 0x01E0(0x0030)(HasGetValueTypeHash)
	...
	struct FUniqueNetIdRepl                       CallFunc_GetPlayerStateUniqueNetId_ReturnValue_1;  // 0x0240(0x0030)(HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_StriStri_ReturnValue;          // 0x0270(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_271[0x7];                                      // 0x0271(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FUniqueNetIdRepl                       CallFunc_CreateUniquePlayerId_ReturnValue;         // 0x0278(0x0030)(HasGetValueTypeHash)
	class FString                                 CallFunc_GetNativePlatformInfo_NativePlatformId;   // 0x02A8(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_GetNativePlatformInfo_NativePlatform;     // 0x02B8(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetNativePlatformInfo_ReturnValue;        // 0x02C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(B_ImpostorGameMode_C_SetupMatchStartDetails) == 0x000008, "Wrong alignment on B_ImpostorGameMode_C_SetupMatchStartDetails");
static_assert(sizeof(B_ImpostorGameMode_C_SetupMatchStartDetails) == 0x0002D0, "Wrong size on B_ImpostorGameMode_C_SetupMatchStartDetails");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CurrentPlayerIsPSN) == 0x000000, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CurrentPlayerIsPSN' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, HunterPlayers) == 0x000008, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::HunterPlayers' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CurrentPlayerId) == 0x000018, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CurrentPlayerId' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, PlayersToAdd) == 0x000048, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::PlayersToAdd' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CurrentPlayerState) == 0x000058, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CurrentPlayerState' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, GameInstance) == 0x000060, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::GameInstance' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, Temp_int_Array_Index_Variable) == 0x000068, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetGameInstance_ReturnValue) == 0x000070, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, K2Node_DynamicCast_AsB_Game_Instance) == 0x000078, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::K2Node_DynamicCast_AsB_Game_Instance' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, K2Node_DynamicCast_bSuccess) == 0x000080, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetGameState_ReturnValue) == 0x000088, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetGameState_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, Temp_int_Loop_Counter_Variable) == 0x000090, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_Array_Get_Item) == 0x000098, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, K2Node_DynamicCast_AsB_Player_State) == 0x0000A0, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::K2Node_DynamicCast_AsB_Player_State' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, K2Node_DynamicCast_bSuccess_1) == 0x0000A8, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_Add_IntInt_ReturnValue) == 0x0000AC, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_Array_Length_ReturnValue) == 0x0000B0, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_Less_IntInt_ReturnValue) == 0x0000B4, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetPlayerIdForMatch_NetId) == 0x0000B8, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetPlayerIdForMatch_NetId' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetPlayerIdForMatch_IsPSNUser) == 0x0000E8, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetPlayerIdForMatch_IsPSNUser' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, K2Node_MakeStruct_MatchTeam) == 0x0000F0, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::K2Node_MakeStruct_MatchTeam' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, K2Node_MakeArray_Array) == 0x000120, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_Array_Add_ReturnValue) == 0x000130, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetPlayerName_ReturnValue) == 0x000138, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetPlayerName_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, K2Node_MakeStruct_MatchPlayer) == 0x000148, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::K2Node_MakeStruct_MatchPlayer' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_Array_Add_ReturnValue_1) == 0x0001A0, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_Array_Add_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetGameInstanceSubsystem_ReturnValue) == 0x0001A8, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetGameInstanceSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetGameInstanceSubsystem_ReturnValue_1) == 0x0001B0, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetGameInstanceSubsystem_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_Array_Length_ReturnValue_1) == 0x0001B8, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_Conv_IntToString_ReturnValue) == 0x0001C0, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_Conv_IntToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_Concat_StrStr_ReturnValue) == 0x0001D0, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetPlayerStateUniqueNetId_ReturnValue) == 0x0001E0, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetPlayerStateUniqueNetId_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_Concat_StrStr_ReturnValue_1) == 0x000210, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_Concat_StrStr_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetNativePlatformAccountName_NativePlatformId) == 0x000220, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetNativePlatformAccountName_NativePlatformId' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetNativePlatformAccountName_NativePlatform) == 0x000230, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetNativePlatformAccountName_NativePlatform' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetPlayerStateUniqueNetId_ReturnValue_1) == 0x000240, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetPlayerStateUniqueNetId_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_EqualEqual_StriStri_ReturnValue) == 0x000270, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_EqualEqual_StriStri_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_CreateUniquePlayerId_ReturnValue) == 0x000278, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_CreateUniquePlayerId_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetNativePlatformInfo_NativePlatformId) == 0x0002A8, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetNativePlatformInfo_NativePlatformId' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetNativePlatformInfo_NativePlatform) == 0x0002B8, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetNativePlatformInfo_NativePlatform' has a wrong offset!");
static_assert(offsetof(B_ImpostorGameMode_C_SetupMatchStartDetails, CallFunc_GetNativePlatformInfo_ReturnValue) == 0x0002C8, "Member 'B_ImpostorGameMode_C_SetupMatchStartDetails::CallFunc_GetNativePlatformInfo_ReturnValue' has a wrong offset!");
