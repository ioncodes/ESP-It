...
// class FString                           URL                                                    (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EVaRestRequestVerb                      Verb                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FString                           CustomVerb                                             (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FString                           AdditionalHeader                                       (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FString                           AdditionalHeaderValue                                  (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EVaRestRequestContentType               ContentType                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UVaRestJsonObject*                VaRestJson                                             (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TDelegate<void(class UVaRestRequestJSON* Request)>Callback                                               (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UVaRestSubsystem::CallURLCustomVerb(const class FString& URL, EVaRestRequestVerb Verb, const class FString& CustomVerb, const class FString& AdditionalHeader, const class FString& AdditionalHeaderValue, EVaRestRequestContentType ContentType, class UVaRestJsonObject* VaRestJson, const TDelegate<void(class UVaRestRequestJSON* Request)>& Callback)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("VaRestSubsystem", "CallURLCustomVerb");

	Params::VaRestSubsystem_CallURLCustomVerb Parms{};

	Parms.URL = std::move(URL);
	Parms.Verb = Verb;
	Parms.CustomVerb = std::move(CustomVerb);
	Parms.AdditionalHeader = std::move(AdditionalHeader);
	Parms.AdditionalHeaderValue = std::move(AdditionalHeaderValue);
	Parms.ContentType = ContentType;
	Parms.VaRestJson = VaRestJson;
	Parms.Callback = Callback;
