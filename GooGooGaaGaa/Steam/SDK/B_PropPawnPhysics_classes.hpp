...
public:
	...
	struct FRotator                               LastControllerRotation;                            // 0x05C8(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
public:
	...
	void ClientUpdateControllerRotation();
...
static_assert(sizeof(AB_PropPawnPhysics_C) == 0x0005E0, "Wrong size on AB_PropPawnPhysics_C");
...
static_assert(offsetof(AB_PropPawnPhysics_C, LastControllerRotation) == 0x0005C8, "Member 'AB_PropPawnPhysics_C::LastControllerRotation' has a wrong offset!");
