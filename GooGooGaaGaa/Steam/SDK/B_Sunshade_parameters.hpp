...
public:
	...
	EHighlightChannel                             K2Node_Event_Channel;                              // 0x0008(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        CallFunc_UpdateTransformIfNeeded_DeltaTime_ImplicitCast; // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(B_Sunshade_C_ExecuteUbergraph_B_Sunshade) == 0x000008, "Wrong alignment on B_Sunshade_C_ExecuteUbergraph_B_Sunshade");
static_assert(sizeof(B_Sunshade_C_ExecuteUbergraph_B_Sunshade) == 0x000018, "Wrong size on B_Sunshade_C_ExecuteUbergraph_B_Sunshade");
...
static_assert(offsetof(B_Sunshade_C_ExecuteUbergraph_B_Sunshade, K2Node_Event_Channel) == 0x000008, "Member 'B_Sunshade_C_ExecuteUbergraph_B_Sunshade::K2Node_Event_Channel' has a wrong offset!");
static_assert(offsetof(B_Sunshade_C_ExecuteUbergraph_B_Sunshade, CallFunc_UpdateTransformIfNeeded_DeltaTime_ImplicitCast) == 0x000010, "Member 'B_Sunshade_C_ExecuteUbergraph_B_Sunshade::CallFunc_UpdateTransformIfNeeded_DeltaTime_ImplicitCast' has a wrong offset!");
...
struct B_Sunshade_C_UpdateTransformIfNeeded final
{
public:
	...
	bool                                          CallFunc_NearlyEqual_TransformTransform_ReturnValue; // 0x00D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FTransform                             CallFunc_GetRelativeTransform_ReturnValue_1;       // 0x01D0(0x0060)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FTransform                             CallFunc_TInterpTo_ReturnValue;                    // 0x0230(0x0060)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(B_Sunshade_C_UpdateTransformIfNeeded) == 0x000010, "Wrong alignment on B_Sunshade_C_UpdateTransformIfNeeded");
static_assert(sizeof(B_Sunshade_C_UpdateTransformIfNeeded) == 0x0002A0, "Wrong size on B_Sunshade_C_UpdateTransformIfNeeded");
static_assert(offsetof(B_Sunshade_C_UpdateTransformIfNeeded, DeltaTime) == 0x000000, "Member 'B_Sunshade_C_UpdateTransformIfNeeded::DeltaTime' has a wrong offset!");
static_assert(offsetof(B_Sunshade_C_UpdateTransformIfNeeded, TargetTransform) == 0x000010, "Member 'B_Sunshade_C_UpdateTransformIfNeeded::TargetTransform' has a wrong offset!");
static_assert(offsetof(B_Sunshade_C_UpdateTransformIfNeeded, CallFunc_GetRelativeTransform_ReturnValue) == 0x000070, "Member 'B_Sunshade_C_UpdateTransformIfNeeded::CallFunc_GetRelativeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Sunshade_C_UpdateTransformIfNeeded, CallFunc_NearlyEqual_TransformTransform_ReturnValue) == 0x0000D0, "Member 'B_Sunshade_C_UpdateTransformIfNeeded::CallFunc_NearlyEqual_TransformTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Sunshade_C_UpdateTransformIfNeeded, CallFunc_K2_SetRelativeTransform_SweepHitResult) == 0x0000D8, "Member 'B_Sunshade_C_UpdateTransformIfNeeded::CallFunc_K2_SetRelativeTransform_SweepHitResult' has a wrong offset!");
static_assert(offsetof(B_Sunshade_C_UpdateTransformIfNeeded, CallFunc_GetRelativeTransform_ReturnValue_1) == 0x0001D0, "Member 'B_Sunshade_C_UpdateTransformIfNeeded::CallFunc_GetRelativeTransform_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_Sunshade_C_UpdateTransformIfNeeded, CallFunc_TInterpTo_ReturnValue) == 0x000230, "Member 'B_Sunshade_C_UpdateTransformIfNeeded::CallFunc_TInterpTo_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Sunshade_C_UpdateTransformIfNeeded, CallFunc_TInterpTo_DeltaTime_ImplicitCast) == 0x000290, "Member 'B_Sunshade_C_UpdateTransformIfNeeded::CallFunc_TInterpTo_DeltaTime_ImplicitCast' has a wrong offset!");
