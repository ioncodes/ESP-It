...
void AB_GameState_C::DetermineTickRates()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_GameState_C", "DetermineTickRates");
...
void AB_GameState_C::ApplyClientTickRate()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_GameState_C", "ApplyClientTickRate");

	UObject::ProcessEvent(Func, nullptr);
}


// Function B_GameState.B_GameState_C.OnRep_TargetClientTickRate
// (BlueprintCallable, BlueprintEvent)

void AB_GameState_C::OnRep_TargetClientTickRate()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_GameState_C", "OnRep_TargetClientTickRate");
