...
static_assert(sizeof(WB_FPSCounter_C_ExecuteUbergraph_WB_FPSCounter) == 0x000110, "Wrong size on WB_FPSCounter_C_ExecuteUbergraph_WB_FPSCounter");
...
static_assert(offsetof(WB_FPSCounter_C_ExecuteUbergraph_WB_FPSCounter, K2Node_MakeArray_Array) == 0x0000F0, "Member 'WB_FPSCounter_C_ExecuteUbergraph_WB_FPSCounter::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WB_FPSCounter_C_ExecuteUbergraph_WB_FPSCounter, CallFunc_Format_ReturnValue) == 0x000100, "Member 'WB_FPSCounter_C_ExecuteUbergraph_WB_FPSCounter::CallFunc_Format_ReturnValue' has a wrong offset!");
