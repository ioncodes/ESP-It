...
public:
	...
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AB_PlayerController_C*                  CallFunc_GetFirstLocalPlayerController_PlayerController; // 0x0030(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_ParseChatCommand_IsChatCommand;           // 0x00E8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(B_IngameUIManager_C_HandleChatCommand) == 0x0000F0, "Wrong size on B_IngameUIManager_C_HandleChatCommand");
...
static_assert(offsetof(B_IngameUIManager_C_HandleChatCommand, CallFunc_GetFirstLocalPlayerController_ReturnValue) == 0x000018, "Member 'B_IngameUIManager_C_HandleChatCommand::CallFunc_GetFirstLocalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_HandleChatCommand, CallFunc_GetObjectClass_ReturnValue) == 0x000020, "Member 'B_IngameUIManager_C_HandleChatCommand::CallFunc_GetObjectClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_HandleChatCommand, CallFunc_NotEqual_ClassClass_ReturnValue) == 0x000028, "Member 'B_IngameUIManager_C_HandleChatCommand::CallFunc_NotEqual_ClassClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_HandleChatCommand, CallFunc_GetFirstLocalPlayerController_PlayerController) == 0x000030, "Member 'B_IngameUIManager_C_HandleChatCommand::CallFunc_GetFirstLocalPlayerController_PlayerController' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_HandleChatCommand, CallFunc_FCeil_ReturnValue) == 0x000038, "Member 'B_IngameUIManager_C_HandleChatCommand::CallFunc_FCeil_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_HandleChatCommand, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x00003C, "Member 'B_IngameUIManager_C_HandleChatCommand::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_HandleChatCommand, CallFunc_Conv_IntToInt64_ReturnValue) == 0x000040, "Member 'B_IngameUIManager_C_HandleChatCommand::CallFunc_Conv_IntToInt64_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_HandleChatCommand, K2Node_MakeStruct_FormatArgumentData) == 0x000048, "Member 'B_IngameUIManager_C_HandleChatCommand::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
...
static_assert(offsetof(B_IngameUIManager_C_HandleChatCommand, CallFunc_Not_PreBool_ReturnValue) == 0x0000B0, "Member 'B_IngameUIManager_C_HandleChatCommand::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(B_IngameUIManager_C_HandleChatCommand, CallFunc_Conv_TextToString_ReturnValue) == 0x0000D8, "Member 'B_IngameUIManager_C_HandleChatCommand::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_HandleChatCommand, CallFunc_ParseChatCommand_IsChatCommand) == 0x0000E8, "Member 'B_IngameUIManager_C_HandleChatCommand::CallFunc_ParseChatCommand_IsChatCommand' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_HandleChatCommand, CallFunc_TextIsEmpty_ReturnValue) == 0x0000E9, "Member 'B_IngameUIManager_C_HandleChatCommand::CallFunc_TextIsEmpty_ReturnValue' has a wrong offset!");
...
{
public:
	class UWB_ImpostorHUD_C*                      K2Node_DynamicCast_AsWB_Impostor_HUD;              // 0x0000(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsUserInterfaceHidden_UserInterfaceIsHidden; // 0x000A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(B_IngameUIManager_C_RefreshHUDVisibility) == 0x000008, "Wrong alignment on B_IngameUIManager_C_RefreshHUDVisibility");
static_assert(sizeof(B_IngameUIManager_C_RefreshHUDVisibility) == 0x000010, "Wrong size on B_IngameUIManager_C_RefreshHUDVisibility");
static_assert(offsetof(B_IngameUIManager_C_RefreshHUDVisibility, K2Node_DynamicCast_AsWB_Impostor_HUD) == 0x000000, "Member 'B_IngameUIManager_C_RefreshHUDVisibility::K2Node_DynamicCast_AsWB_Impostor_HUD' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_RefreshHUDVisibility, K2Node_DynamicCast_bSuccess) == 0x000008, "Member 'B_IngameUIManager_C_RefreshHUDVisibility::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_RefreshHUDVisibility, CallFunc_IsInViewport_ReturnValue) == 0x000009, "Member 'B_IngameUIManager_C_RefreshHUDVisibility::CallFunc_IsInViewport_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_RefreshHUDVisibility, CallFunc_IsUserInterfaceHidden_UserInterfaceIsHidden) == 0x00000A, "Member 'B_IngameUIManager_C_RefreshHUDVisibility::CallFunc_IsUserInterfaceHidden_UserInterfaceIsHidden' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_RefreshHUDVisibility, CallFunc_IsValid_ReturnValue) == 0x00000B, "Member 'B_IngameUIManager_C_RefreshHUDVisibility::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_RefreshHUDVisibility, CallFunc_Not_PreBool_ReturnValue) == 0x00000C, "Member 'B_IngameUIManager_C_RefreshHUDVisibility::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_IngameUIManager_C_RefreshHUDVisibility, CallFunc_BooleanAND_ReturnValue) == 0x00000D, "Member 'B_IngameUIManager_C_RefreshHUDVisibility::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
public:
	...
	class APlayerController*                      CallFunc_GetOwningPlayer_PlayerController_1;       // 0x0030(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(B_IngameUIManager_C_ShowHUD, CallFunc_GetOwningPlayer_PlayerController) == 0x000020, "Member 'B_IngameUIManager_C_ShowHUD::CallFunc_GetOwningPlayer_PlayerController' has a wrong offset!");
...
static_assert(offsetof(B_IngameUIManager_C_ShowHUD, CallFunc_GetOwningPlayer_PlayerController_1) == 0x000030, "Member 'B_IngameUIManager_C_ShowHUD::CallFunc_GetOwningPlayer_PlayerController_1' has a wrong offset!");
