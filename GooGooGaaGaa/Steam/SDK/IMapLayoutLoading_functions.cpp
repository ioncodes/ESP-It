...
void IIMapLayoutLoading_C::SpawnActionPlaceableStatic(class UClass* Class_0, const struct FTransform& Transform, bool Activated, TArray<uint8>& MaterialIndices, class ABP_PlaceableStaticProp_C** SpawnedActor)
{
...
void IIMapLayoutLoading_C::SpawnPlaceableStatic(class UClass* Class_0, const struct FTransform& Transform, TArray<uint8>& MaterialIndices, class ABP_PlaceableStaticProp_C** SpawnedActor)
{
	static class UFunction* Func = nullptr;
