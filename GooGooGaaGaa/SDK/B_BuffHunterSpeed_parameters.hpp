...
public:
	...
	uint8                                         Pad_4B32[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4B33[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4B34[0x4];                                     // 0x0064(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(B_BuffHunterSpeed_C_BuffStart, Param_PlayerState) == 0x000000, "Member 'B_BuffHunterSpeed_C_BuffStart::Param_PlayerState' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4B35[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          CallFunc_IsDedicatedServer_ReturnValue_1;          // 0x0120(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4B36[0x7];                                     // 0x0121(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UB_PowerupParametersSubsystem_C*        CallFunc_GetWorldSubsystem_ReturnValue;            // 0x0128(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0130(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4B37[0x3];                                     // 0x0131(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         K2Node_VariableSet_MaxWalkSpeed_ImplicitCast;      // 0x0134(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_VariableSet_MaxWalkSpeedCrouched_ImplicitCast; // 0x0138(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(B_BuffHunterSpeed_C_ExecuteUbergraph_B_BuffHunterSpeed) == 0x000140, "Wrong size on B_BuffHunterSpeed_C_ExecuteUbergraph_B_BuffHunterSpeed");
...
static_assert(offsetof(B_BuffHunterSpeed_C_ExecuteUbergraph_B_BuffHunterSpeed, CallFunc_IsDedicatedServer_ReturnValue_1) == 0x000120, "Member 'B_BuffHunterSpeed_C_ExecuteUbergraph_B_BuffHunterSpeed::CallFunc_IsDedicatedServer_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_BuffHunterSpeed_C_ExecuteUbergraph_B_BuffHunterSpeed, CallFunc_GetWorldSubsystem_ReturnValue) == 0x000128, "Member 'B_BuffHunterSpeed_C_ExecuteUbergraph_B_BuffHunterSpeed::CallFunc_GetWorldSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_BuffHunterSpeed_C_ExecuteUbergraph_B_BuffHunterSpeed, CallFunc_IsValid_ReturnValue) == 0x000130, "Member 'B_BuffHunterSpeed_C_ExecuteUbergraph_B_BuffHunterSpeed::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_BuffHunterSpeed_C_ExecuteUbergraph_B_BuffHunterSpeed, K2Node_VariableSet_MaxWalkSpeed_ImplicitCast) == 0x000134, "Member 'B_BuffHunterSpeed_C_ExecuteUbergraph_B_BuffHunterSpeed::K2Node_VariableSet_MaxWalkSpeed_ImplicitCast' has a wrong offset!");
static_assert(offsetof(B_BuffHunterSpeed_C_ExecuteUbergraph_B_BuffHunterSpeed, K2Node_VariableSet_MaxWalkSpeedCrouched_ImplicitCast) == 0x000138, "Member 'B_BuffHunterSpeed_C_ExecuteUbergraph_B_BuffHunterSpeed::K2Node_VariableSet_MaxWalkSpeedCrouched_ImplicitCast' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4B38[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4B39[0x4];                                     // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	class UCharacterMovementComponent*            Param_CharacterMovementComp;                       // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(B_BuffHunterSpeed_C_SetMovementMulti, Param_CharacterMovementComp) == 0x000000, "Member 'B_BuffHunterSpeed_C_SetMovementMulti::Param_CharacterMovementComp' has a wrong offset!");
