...
#include "WB_StaminaBar_classes.hpp"
#include "WB_StaminaBar_parameters.hpp"
...
ESlateVisibility UWB_StaminaBar_C::GetVisibility_0()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WB_StaminaBar_C", "GetVisibility_0");

	Params::WB_StaminaBar_C_GetVisibility_0 Parms{};
...
void UWB_StaminaBar_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WB_StaminaBar_C", "Tick");

	Params::WB_StaminaBar_C_Tick Parms{};
