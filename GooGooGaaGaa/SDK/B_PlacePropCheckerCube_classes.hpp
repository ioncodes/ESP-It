...
static_assert(sizeof(AB_PlacePropCheckerCube_C) == 0x0002A8, "Wrong size on AB_PlacePropCheckerCube_C");
static_assert(offsetof(AB_PlacePropCheckerCube_C, Box) == 0x000298, "Member 'AB_PlacePropCheckerCube_C::Box' has a wrong offset!");
static_assert(offsetof(AB_PlacePropCheckerCube_C, Cube) == 0x0002A0, "Member 'AB_PlacePropCheckerCube_C::Cube' has a wrong offset!");
