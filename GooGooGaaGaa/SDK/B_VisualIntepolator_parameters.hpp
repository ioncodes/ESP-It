...
public:
	...
	uint8                                         Pad_1E3[0x4];                                      // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E4[0x4];                                      // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E5[0x3];                                      // 0x0031(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E6[0x7];                                      // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E7[0x8];                                      // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E8[0x7];                                      // 0x01F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E9[0x7];                                      // 0x0221(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FVector                                CallFunc_Divide_VectorFloat_ReturnValue;           // 0x0260(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AB_StaticMeshProp_C*                    K2Node_DynamicCast_AsB_Static_Mesh_Prop;           // 0x0298(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x02A0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1EA[0x3];                                      // 0x02A1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_VInterpTo_DeltaTime_ImplicitCast;         // 0x02A4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_SetScalarParameterValueOnMaterials_ParameterValue_ImplicitCast; // 0x02A8(0x0004)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator) == 0x0002B0, "Wrong size on B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator");
...
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, CallFunc_K2_SetActorTransform_ReturnValue) == 0x0001F8, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::CallFunc_K2_SetActorTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, CallFunc_GetWorldDeltaSeconds_ReturnValue) == 0x000200, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::CallFunc_GetWorldDeltaSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, CallFunc_K2_GetActorLocation_ReturnValue_2) == 0x000208, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::CallFunc_K2_GetActorLocation_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x000220, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, CallFunc_K2_GetActorLocation_ReturnValue_3) == 0x000228, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::CallFunc_K2_GetActorLocation_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, CallFunc_GetWorldDeltaSeconds_ReturnValue_1) == 0x000240, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::CallFunc_GetWorldDeltaSeconds_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, CallFunc_Subtract_VectorVector_ReturnValue_1) == 0x000248, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::CallFunc_Subtract_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, CallFunc_Divide_VectorFloat_ReturnValue) == 0x000260, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::CallFunc_Divide_VectorFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, CallFunc_GetOwner_ReturnValue) == 0x000278, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, CallFunc_VInterpTo_ReturnValue) == 0x000280, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::CallFunc_VInterpTo_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, K2Node_DynamicCast_AsB_Static_Mesh_Prop) == 0x000298, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::K2Node_DynamicCast_AsB_Static_Mesh_Prop' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, K2Node_DynamicCast_bSuccess) == 0x0002A0, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, CallFunc_VInterpTo_DeltaTime_ImplicitCast) == 0x0002A4, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::CallFunc_VInterpTo_DeltaTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator, CallFunc_SetScalarParameterValueOnMaterials_ParameterValue_ImplicitCast) == 0x0002A8, "Member 'B_VisualIntepolator_C_ExecuteUbergraph_B_VisualIntepolator::CallFunc_SetScalarParameterValueOnMaterials_ParameterValue_ImplicitCast' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1EB[0xF];                                      // 0x0121(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1EC[0x3];                                      // 0x0209(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_TInterpTo_InterpSpeed_ImplicitCast;       // 0x020C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_TInterpTo_DeltaTime_ImplicitCast;         // 0x0210(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(B_VisualIntepolator_C_UpdateInterpolation) == 0x000220, "Wrong size on B_VisualIntepolator_C_UpdateInterpolation");
...
static_assert(offsetof(B_VisualIntepolator_C_UpdateInterpolation, CallFunc_K2_SetActorTransform_ReturnValue) == 0x000208, "Member 'B_VisualIntepolator_C_UpdateInterpolation::CallFunc_K2_SetActorTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_UpdateInterpolation, CallFunc_TInterpTo_InterpSpeed_ImplicitCast) == 0x00020C, "Member 'B_VisualIntepolator_C_UpdateInterpolation::CallFunc_TInterpTo_InterpSpeed_ImplicitCast' has a wrong offset!");
static_assert(offsetof(B_VisualIntepolator_C_UpdateInterpolation, CallFunc_TInterpTo_DeltaTime_ImplicitCast) == 0x000210, "Member 'B_VisualIntepolator_C_UpdateInterpolation::CallFunc_TInterpTo_DeltaTime_ImplicitCast' has a wrong offset!");
