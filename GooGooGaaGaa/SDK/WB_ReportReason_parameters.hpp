...
public:
	...
	uint8                                         Pad_36FA[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_36FC[0x7];                                     // 0x0031(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_36FD[0x3];                                     // 0x0059(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WB_ReportReason_C_Get_PunishmentText_Text_0) == 0x0000B8, "Wrong size on WB_ReportReason_C_Get_PunishmentText_Text_0");
...
static_assert(offsetof(WB_ReportReason_C_Get_PunishmentText_Text_0, CallFunc_GetPlayerName_ReturnValue) == 0x000018, "Member 'WB_ReportReason_C_Get_PunishmentText_Text_0::CallFunc_GetPlayerName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ReportReason_C_Get_PunishmentText_Text_0, CallFunc_Conv_StringToText_ReturnValue) == 0x000028, "Member 'WB_ReportReason_C_Get_PunishmentText_Text_0::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ReportReason_C_Get_PunishmentText_Text_0, K2Node_MakeStruct_FormatArgumentData) == 0x000040, "Member 'WB_ReportReason_C_Get_PunishmentText_Text_0::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WB_ReportReason_C_Get_PunishmentText_Text_0, K2Node_MakeArray_Array) == 0x000090, "Member 'WB_ReportReason_C_Get_PunishmentText_Text_0::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WB_ReportReason_C_Get_PunishmentText_Text_0, CallFunc_Format_ReturnValue) == 0x0000A0, "Member 'WB_ReportReason_C_Get_PunishmentText_Text_0::CallFunc_Format_ReturnValue' has a wrong offset!");
