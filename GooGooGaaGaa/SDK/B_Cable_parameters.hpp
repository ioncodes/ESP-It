...
public:
	...
	uint8                                         Pad_3936[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3937[0x7];                                     // 0x0099(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3938[0x7];                                     // 0x00E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_393A[0xC];                                     // 0x0214(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_393B[0x3];                                     // 0x0285(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CallFunc_Array_Get_Item_6;                         // 0x0288(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AB_SmallLantern_C*                      CallFunc_FinishSpawningActor_ReturnValue;          // 0x02C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FRotator                               CallFunc_RotatorFromAxisAndAngle_ReturnValue;      // 0x02C8(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor)
	int32                                         CallFunc_Array_Add_ReturnValue_1;                  // 0x02E0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_393C[0x4];                                     // 0x02E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               CallFunc_RInterpTo_ReturnValue;                    // 0x02E8(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FHitResult                             CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x0300(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	double                                        K2Node_VariableSet_Force_ImplicitCast;             // 0x03F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(B_Cable_C_ExecuteUbergraph_B_Cable) == 0x000010, "Wrong alignment on B_Cable_C_ExecuteUbergraph_B_Cable");
static_assert(sizeof(B_Cable_C_ExecuteUbergraph_B_Cable) == 0x000400, "Wrong size on B_Cable_C_ExecuteUbergraph_B_Cable");
...
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_Array_Add_ReturnValue) == 0x000210, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_Conv_VectorToTransform_ReturnValue) == 0x000220, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_Conv_VectorToTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_Array_Length_ReturnValue_1) == 0x000280, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_Less_IntInt_ReturnValue_1) == 0x000284, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_Array_Get_Item_6) == 0x000288, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_Array_Get_Item_6' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x0002A0, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_Subtract_VectorVector_ReturnValue) == 0x0002A8, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_Subtract_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_FinishSpawningActor_ReturnValue) == 0x0002C0, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_RotatorFromAxisAndAngle_ReturnValue) == 0x0002C8, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_RotatorFromAxisAndAngle_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_Array_Add_ReturnValue_1) == 0x0002E0, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_Array_Add_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_RInterpTo_ReturnValue) == 0x0002E8, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_RInterpTo_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_K2_SetWorldRotation_SweepHitResult) == 0x000300, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_K2_SetWorldRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_Add_DoubleDouble_A_ImplicitCast) == 0x0003E8, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_Add_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, CallFunc_Divide_DoubleDouble_B_ImplicitCast) == 0x0003F0, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::CallFunc_Divide_DoubleDouble_B_ImplicitCast' has a wrong offset!");
static_assert(offsetof(B_Cable_C_ExecuteUbergraph_B_Cable, K2Node_VariableSet_Force_ImplicitCast) == 0x0003F8, "Member 'B_Cable_C_ExecuteUbergraph_B_Cable::K2Node_VariableSet_Force_ImplicitCast' has a wrong offset!");
