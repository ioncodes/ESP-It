...
public:
	...
	uint8                                         Pad_4C98[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WB_ResultScreenBase_C_GetText_0) == 0x000150, "Wrong size on WB_ResultScreenBase_C_GetText_0");
...
static_assert(offsetof(WB_ResultScreenBase_C_GetText_0, Temp_bool_Variable) == 0x000018, "Member 'WB_ResultScreenBase_C_GetText_0::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WB_ResultScreenBase_C_GetText_0, CallFunc_GetGameState_ReturnValue) == 0x000020, "Member 'WB_ResultScreenBase_C_GetText_0::CallFunc_GetGameState_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ResultScreenBase_C_GetText_0, K2Node_DynamicCast_AsB_Game_State) == 0x000028, "Member 'WB_ResultScreenBase_C_GetText_0::K2Node_DynamicCast_AsB_Game_State' has a wrong offset!");
static_assert(offsetof(WB_ResultScreenBase_C_GetText_0, K2Node_DynamicCast_bSuccess) == 0x000030, "Member 'WB_ResultScreenBase_C_GetText_0::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WB_ResultScreenBase_C_GetText_0, CallFunc_Conv_IntToInt64_ReturnValue) == 0x000038, "Member 'WB_ResultScreenBase_C_GetText_0::CallFunc_Conv_IntToInt64_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ResultScreenBase_C_GetText_0, K2Node_MakeStruct_FormatArgumentData) == 0x000040, "Member 'WB_ResultScreenBase_C_GetText_0::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WB_ResultScreenBase_C_GetText_0, CallFunc_Conv_IntToInt64_ReturnValue_1) == 0x000090, "Member 'WB_ResultScreenBase_C_GetText_0::CallFunc_Conv_IntToInt64_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WB_ResultScreenBase_C_GetText_0, K2Node_MakeArray_Array) == 0x000098, "Member 'WB_ResultScreenBase_C_GetText_0::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WB_ResultScreenBase_C_GetText_0, K2Node_MakeStruct_FormatArgumentData_1) == 0x0000A8, "Member 'WB_ResultScreenBase_C_GetText_0::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(WB_ResultScreenBase_C_GetText_0, CallFunc_Format_ReturnValue) == 0x0000F8, "Member 'WB_ResultScreenBase_C_GetText_0::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ResultScreenBase_C_GetText_0, K2Node_MakeArray_Array_1) == 0x000110, "Member 'WB_ResultScreenBase_C_GetText_0::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(WB_ResultScreenBase_C_GetText_0, CallFunc_Format_ReturnValue_1) == 0x000120, "Member 'WB_ResultScreenBase_C_GetText_0::CallFunc_Format_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WB_ResultScreenBase_C_GetText_0, K2Node_Select_Default) == 0x000138, "Member 'WB_ResultScreenBase_C_GetText_0::K2Node_Select_Default' has a wrong offset!");
