...
public:
	...
	class UB_HitBlinker_C*                        B_HitBlinker;                                      // 0x02A0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UBoxComponent*                          PropBlocker2;                                      // 0x02A8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UBoxComponent*                          PropBlocker;                                       // 0x02B0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                   SM_DoorFrame;                                      // 0x02B8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	class UStaticMeshComponent*                   SM_Door;                                           // 0x02C8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_4877[0x7];                                     // 0x0341(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4878[0x5];                                     // 0x0353(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(AB_IntDoor_C, UberGraphFrame) == 0x000298, "Member 'AB_IntDoor_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_IntDoor_C, B_HitBlinker) == 0x0002A0, "Member 'AB_IntDoor_C::B_HitBlinker' has a wrong offset!");
static_assert(offsetof(AB_IntDoor_C, PropBlocker2) == 0x0002A8, "Member 'AB_IntDoor_C::PropBlocker2' has a wrong offset!");
static_assert(offsetof(AB_IntDoor_C, PropBlocker) == 0x0002B0, "Member 'AB_IntDoor_C::PropBlocker' has a wrong offset!");
static_assert(offsetof(AB_IntDoor_C, SM_DoorFrame) == 0x0002B8, "Member 'AB_IntDoor_C::SM_DoorFrame' has a wrong offset!");
static_assert(offsetof(AB_IntDoor_C, PhysicsConstraint) == 0x0002C0, "Member 'AB_IntDoor_C::PhysicsConstraint' has a wrong offset!");
static_assert(offsetof(AB_IntDoor_C, SM_Door) == 0x0002C8, "Member 'AB_IntDoor_C::SM_Door' has a wrong offset!");
