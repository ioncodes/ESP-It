...
public:
	...
	struct FPointerToUberGraphFrame               UberGraphFrame_B_ObjectiveKillSpectator_C;         // 0x0478(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(AB_ObjectiveKillSpectator_C) == 0x000480, "Wrong size on AB_ObjectiveKillSpectator_C");
static_assert(offsetof(AB_ObjectiveKillSpectator_C, UberGraphFrame_B_ObjectiveKillSpectator_C) == 0x000478, "Member 'AB_ObjectiveKillSpectator_C::UberGraphFrame_B_ObjectiveKillSpectator_C' has a wrong offset!");
