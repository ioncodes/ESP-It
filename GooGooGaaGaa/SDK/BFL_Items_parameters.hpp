...
public:
	...
	uint8                                         Pad_397E[0x4];                                     // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_397F[0x3];                                     // 0x006D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_Add_IntInt_ReturnValue;                   // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3980[0x4];                                     // 0x0074(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FS_RecipeInfo                          CallFunc_GetRecipe_ReturnValue;                    // 0x0078(0x0088)(HasGetValueTypeHash)
	bool                                          CallFunc_TryAddItemToClientItemUnlockList_HasBeenAdded; // 0x0100(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_TryAddItemToClientItemUnlockList_HasBeenAdded_1; // 0x0101(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsRecipeIdValid_ReturnValue;              // 0x0102(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BFL_Items_C_GetClientItemUnlocks) == 0x000108, "Wrong size on BFL_Items_C_GetClientItemUnlocks");
...
static_assert(offsetof(BFL_Items_C_GetClientItemUnlocks, CallFunc_TryAddItemToClientItemUnlockList_HasBeenAdded) == 0x000100, "Member 'BFL_Items_C_GetClientItemUnlocks::CallFunc_TryAddItemToClientItemUnlockList_HasBeenAdded' has a wrong offset!");
static_assert(offsetof(BFL_Items_C_GetClientItemUnlocks, CallFunc_TryAddItemToClientItemUnlockList_HasBeenAdded_1) == 0x000101, "Member 'BFL_Items_C_GetClientItemUnlocks::CallFunc_TryAddItemToClientItemUnlockList_HasBeenAdded_1' has a wrong offset!");
static_assert(offsetof(BFL_Items_C_GetClientItemUnlocks, CallFunc_IsRecipeIdValid_ReturnValue) == 0x000102, "Member 'BFL_Items_C_GetClientItemUnlocks::CallFunc_IsRecipeIdValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_Items_C_GetClientItemUnlocks, CallFunc_Not_PreBool_ReturnValue) == 0x000103, "Member 'BFL_Items_C_GetClientItemUnlocks::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3981[0x6];                                     // 0x0022(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3982[0x2];                                     // 0x0036(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	EItemUnlockType                               K2Node_Select_Default;                             // 0x00BA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EItemUnlockType                               K2Node_Select_Default_1;                           // 0x00BB(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsItemIdValid_ReturnValue;                // 0x00BC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3983[0x3];                                     // 0x00BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSClientItemUnlock                     K2Node_MakeStruct_SClientItemUnlock;               // 0x00C0(0x0018)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BFL_Items_C_TryAddItemToClientItemUnlockList) == 0x0000E0, "Wrong size on BFL_Items_C_TryAddItemToClientItemUnlockList");
...
static_assert(offsetof(BFL_Items_C_TryAddItemToClientItemUnlockList, CallFunc_GetSkinItem_Found) == 0x0000B8, "Member 'BFL_Items_C_TryAddItemToClientItemUnlockList::CallFunc_GetSkinItem_Found' has a wrong offset!");
static_assert(offsetof(BFL_Items_C_TryAddItemToClientItemUnlockList, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0000B9, "Member 'BFL_Items_C_TryAddItemToClientItemUnlockList::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_Items_C_TryAddItemToClientItemUnlockList, K2Node_Select_Default) == 0x0000BA, "Member 'BFL_Items_C_TryAddItemToClientItemUnlockList::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BFL_Items_C_TryAddItemToClientItemUnlockList, K2Node_Select_Default_1) == 0x0000BB, "Member 'BFL_Items_C_TryAddItemToClientItemUnlockList::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(BFL_Items_C_TryAddItemToClientItemUnlockList, CallFunc_IsItemIdValid_ReturnValue) == 0x0000BC, "Member 'BFL_Items_C_TryAddItemToClientItemUnlockList::CallFunc_IsItemIdValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_Items_C_TryAddItemToClientItemUnlockList, K2Node_MakeStruct_SClientItemUnlock) == 0x0000C0, "Member 'BFL_Items_C_TryAddItemToClientItemUnlockList::K2Node_MakeStruct_SClientItemUnlock' has a wrong offset!");
static_assert(offsetof(BFL_Items_C_TryAddItemToClientItemUnlockList, CallFunc_Array_Add_ReturnValue) == 0x0000D8, "Member 'BFL_Items_C_TryAddItemToClientItemUnlockList::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
