...
public:
	...
	TScriptInterface<class IUserObjectListEntry>  K2Node_DynamicCast_AsUser_Object_List_Entry;       // 0x00B0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsListItemSelected_ReturnValue;           // 0x00D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UUserWidget*>                    CallFunc_GetDisplayedEntryWidgets_ReturnValue;     // 0x00E8(0x0010)(ConstParm, ReferenceParm, ContainsInstancedReference)
};
...
static_assert(sizeof(WB_TradeWithPlayer_C_NavigateToPreview) == 0x0000F8, "Wrong size on WB_TradeWithPlayer_C_NavigateToPreview");
...
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_GetViewportSize_ReturnValue) == 0x000028, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_GetViewportSize_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_Array_Get_Item) == 0x000038, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_BreakVector2D_X) == 0x000040, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_BreakVector2D_X' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_BreakVector2D_Y) == 0x000048, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_BreakVector2D_Y' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_GetCachedGeometry_ReturnValue) == 0x000050, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_GetCachedGeometry_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000088, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_LocalToViewport_PixelPosition) == 0x000090, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_LocalToViewport_PixelPosition' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_LocalToViewport_ViewportPosition) == 0x0000A0, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_LocalToViewport_ViewportPosition' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, K2Node_DynamicCast_AsUser_Object_List_Entry) == 0x0000B0, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::K2Node_DynamicCast_AsUser_Object_List_Entry' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, K2Node_DynamicCast_bSuccess) == 0x0000C0, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_BreakVector2D_X_1) == 0x0000C8, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_BreakVector2D_X_1' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_BreakVector2D_Y_1) == 0x0000D0, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_BreakVector2D_Y_1' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_IsListItemSelected_ReturnValue) == 0x0000D8, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_IsListItemSelected_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_LessEqual_DoubleDouble_ReturnValue) == 0x0000D9, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_LessEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_Array_Length_ReturnValue) == 0x0000DC, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_Less_IntInt_ReturnValue) == 0x0000E0, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TradeWithPlayer_C_NavigateToPreview, CallFunc_GetDisplayedEntryWidgets_ReturnValue) == 0x0000E8, "Member 'WB_TradeWithPlayer_C_NavigateToPreview::CallFunc_GetDisplayedEntryWidgets_ReturnValue' has a wrong offset!");
