...
public:
	...
	void InpActEvt_QuestionSound_K2Node_InputActionEvent_6(const struct FKey& Key);
	void InpActEvt_SpeakSound_K2Node_InputActionEvent_5(const struct FKey& Key);
	void InpActEvt_ActivateSkill_K2Node_InputActionEvent_4(const struct FKey& Key);
	void InpActEvt_ActivateSkill_K2Node_InputActionEvent_3(const struct FKey& Key);
	void InpActEvt_ActivateUtilitySkill_K2Node_InputActionEvent_2(const struct FKey& Key);
