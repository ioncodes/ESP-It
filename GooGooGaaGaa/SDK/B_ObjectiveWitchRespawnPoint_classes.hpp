...
static_assert(sizeof(AB_ObjectiveWitchRespawnPoint_C) == 0x0002A8, "Wrong size on AB_ObjectiveWitchRespawnPoint_C");
static_assert(offsetof(AB_ObjectiveWitchRespawnPoint_C, Capsule) == 0x000298, "Member 'AB_ObjectiveWitchRespawnPoint_C::Capsule' has a wrong offset!");
static_assert(offsetof(AB_ObjectiveWitchRespawnPoint_C, Arrow) == 0x0002A0, "Member 'AB_ObjectiveWitchRespawnPoint_C::Arrow' has a wrong offset!");
