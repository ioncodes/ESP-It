...
public:
	...
	bool                                          RenderIcon;                                        // 0x0308(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          UpdateIcon;                                        // 0x0309(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsScalable;                                        // 0x030A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_PlaceableActor_C) == 0x000310, "Wrong size on ABP_PlaceableActor_C");
...
static_assert(offsetof(ABP_PlaceableActor_C, RenderIcon) == 0x000308, "Member 'ABP_PlaceableActor_C::RenderIcon' has a wrong offset!");
static_assert(offsetof(ABP_PlaceableActor_C, UpdateIcon) == 0x000309, "Member 'ABP_PlaceableActor_C::UpdateIcon' has a wrong offset!");
static_assert(offsetof(ABP_PlaceableActor_C, IsScalable) == 0x00030A, "Member 'ABP_PlaceableActor_C::IsScalable' has a wrong offset!");
