...
public:
	...
	class FText                                   ValueName;                                         // 0x0008(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm)
...
static_assert(sizeof(B_ProgressionCounter_C_GrantValue) == 0x000030, "Wrong size on B_ProgressionCounter_C_GrantValue");
...
static_assert(offsetof(B_ProgressionCounter_C_GrantValue, Time) == 0x000018, "Member 'B_ProgressionCounter_C_GrantValue::Time' has a wrong offset!");
static_assert(offsetof(B_ProgressionCounter_C_GrantValue, CallFunc_LessEqual_DoubleDouble_ReturnValue) == 0x000020, "Member 'B_ProgressionCounter_C_GrantValue::CallFunc_LessEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ProgressionCounter_C_GrantValue, CallFunc_FTrunc_ReturnValue) == 0x000024, "Member 'B_ProgressionCounter_C_GrantValue::CallFunc_FTrunc_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ProgressionCounter_C_GrantValue, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000028, "Member 'B_ProgressionCounter_C_GrantValue::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(B_ProgressionCounter_C_StartGranting__DelegateSignature) == 0x000018, "Wrong size on B_ProgressionCounter_C_StartGranting__DelegateSignature");
...
static_assert(offsetof(B_ProgressionCounter_C_StartGranting__DelegateSignature, TotalAmount) == 0x000010, "Member 'B_ProgressionCounter_C_StartGranting__DelegateSignature::TotalAmount' has a wrong offset!");
