...
public:
	...
	class FText                                   Notes_9_F4633A6E4F111AA9796E638D8461462A;          // 0x0018(0x0010)(Edit, BlueprintVisible)
};
static_assert(alignof(FVersionInfo) == 0x000008, "Wrong alignment on FVersionInfo");
static_assert(sizeof(FVersionInfo) == 0x000028, "Wrong size on FVersionInfo");
