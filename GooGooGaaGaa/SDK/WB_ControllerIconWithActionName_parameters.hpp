...
public:
	...
	ETeamID                                       Team;                                              // 0x0020(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4B18[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   ActionNameLocalized;                               // 0x0028(0x0018)(Edit, BlueprintVisible)
	...
	uint8                                         Pad_4B19[0x3];                                     // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_Array_Length_ReturnValue;                 // 0x004C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_IntInt_ReturnValue;                  // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4B1A[0x7];                                     // 0x0051(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WB_ControllerIconWithActionName_C_GetActionTextForIndex) == 0x000078, "Wrong size on WB_ControllerIconWithActionName_C_GetActionTextForIndex");
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetActionTextForIndex, Param_Index) == 0x000000, "Member 'WB_ControllerIconWithActionName_C_GetActionTextForIndex::Param_Index' has a wrong offset!");
...
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetActionTextForIndex, Team) == 0x000020, "Member 'WB_ControllerIconWithActionName_C_GetActionTextForIndex::Team' has a wrong offset!");
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetActionTextForIndex, ActionNameLocalized) == 0x000028, "Member 'WB_ControllerIconWithActionName_C_GetActionTextForIndex::ActionNameLocalized' has a wrong offset!");
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetActionTextForIndex, ActionName) == 0x000040, "Member 'WB_ControllerIconWithActionName_C_GetActionTextForIndex::ActionName' has a wrong offset!");
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetActionTextForIndex, K2Node_SwitchEnum_CmpSuccess) == 0x000048, "Member 'WB_ControllerIconWithActionName_C_GetActionTextForIndex::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetActionTextForIndex, CallFunc_Array_Length_ReturnValue) == 0x00004C, "Member 'WB_ControllerIconWithActionName_C_GetActionTextForIndex::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetActionTextForIndex, CallFunc_Less_IntInt_ReturnValue) == 0x000050, "Member 'WB_ControllerIconWithActionName_C_GetActionTextForIndex::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetActionTextForIndex, CallFunc_Conv_NameToText_ReturnValue) == 0x000058, "Member 'WB_ControllerIconWithActionName_C_GetActionTextForIndex::CallFunc_Conv_NameToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetActionTextForIndex, K2Node_SwitchName_CmpSuccess) == 0x000070, "Member 'WB_ControllerIconWithActionName_C_GetActionTextForIndex::K2Node_SwitchName_CmpSuccess' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4B1B[0x3];                                     // 0x0055(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetColorForIndex, Param_Index) == 0x000000, "Member 'WB_ControllerIconWithActionName_C_GetColorForIndex::Param_Index' has a wrong offset!");
...
public:
	...
	class FName                                   ActionName;                                        // 0x001C(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4B1C[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   ActionNameLocalized;                               // 0x0028(0x0018)(Edit, BlueprintVisible)
	class FText                                   CallFunc_GetActionTextForIndex_ReturnValue;        // 0x0040(0x0018)()
};
...
static_assert(sizeof(WB_ControllerIconWithActionName_C_GetText_0) == 0x000058, "Wrong size on WB_ControllerIconWithActionName_C_GetText_0");
...
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetText_0, Param_Index) == 0x000018, "Member 'WB_ControllerIconWithActionName_C_GetText_0::Param_Index' has a wrong offset!");
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetText_0, ActionName) == 0x00001C, "Member 'WB_ControllerIconWithActionName_C_GetText_0::ActionName' has a wrong offset!");
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetText_0, ActionNameLocalized) == 0x000028, "Member 'WB_ControllerIconWithActionName_C_GetText_0::ActionNameLocalized' has a wrong offset!");
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetText_0, CallFunc_GetActionTextForIndex_ReturnValue) == 0x000040, "Member 'WB_ControllerIconWithActionName_C_GetText_0::CallFunc_GetActionTextForIndex_ReturnValue' has a wrong offset!");
...
public:
	class FText                                   ReturnValue;                                       // 0x0000(0x0018)(Parm, OutParm, ReturnParm)
	class FText                                   CallFunc_GetActionTextForIndex_ReturnValue;        // 0x0018(0x0018)()
};
...
static_assert(sizeof(WB_ControllerIconWithActionName_C_GetText_1) == 0x000030, "Wrong size on WB_ControllerIconWithActionName_C_GetText_1");
...
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetText_1, CallFunc_GetActionTextForIndex_ReturnValue) == 0x000018, "Member 'WB_ControllerIconWithActionName_C_GetText_1::CallFunc_GetActionTextForIndex_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WB_ControllerIconWithActionName_C_GetText_2) == 0x000018, "Wrong size on WB_ControllerIconWithActionName_C_GetText_2");
...
public:
	...
	uint8                                         Pad_4B1D[0x3];                                     // 0x0009(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(WB_ControllerIconWithActionName_C_GetVisibilityForIndex, Param_Index) == 0x000000, "Member 'WB_ControllerIconWithActionName_C_GetVisibilityForIndex::Param_Index' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4B1E[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4B1F[0x4];                                     // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4B20[0x6];                                     // 0x0062(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_GetActionTextForIndex_ReturnValue;        // 0x0068(0x0018)()
	TArray<class UTextBlock*>                     K2Node_MakeArray_Array;                            // 0x0080(0x0010)(ReferenceParm, ContainsInstancedReference)
};
...
static_assert(sizeof(WB_ControllerIconWithActionName_C_UpdateStyle) == 0x000090, "Wrong size on WB_ControllerIconWithActionName_C_UpdateStyle");
...
static_assert(offsetof(WB_ControllerIconWithActionName_C_UpdateStyle, K2Node_MakeArray_Array) == 0x000080, "Member 'WB_ControllerIconWithActionName_C_UpdateStyle::K2Node_MakeArray_Array' has a wrong offset!");
