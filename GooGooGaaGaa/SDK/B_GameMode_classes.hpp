...
public:
	...
	void OnMessageArrayProcessed_2F4EA87B48E126019BCA89A0AFF27015(bool bSuccess, const TArray<class FString>& SanitizedMessages);
	void OnCallFailed_2F4EA87B48E126019BCA89A0AFF27015(bool bSuccess, const TArray<class FString>& SanitizedMessages);
	...
	void ShutdownServer();
	void SendSanitizedGameMessageToAll(const class FString& SourcePlayerName, const class FString& TargetPlayerName);
