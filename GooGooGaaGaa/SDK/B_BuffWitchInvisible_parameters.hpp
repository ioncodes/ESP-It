...
static_assert(offsetof(B_BuffWitchInvisible_C_BuffStart, PlayerState_0) == 0x000000, "Member 'B_BuffWitchInvisible_C_BuffStart::PlayerState_0' has a wrong offset!");
