...
namespace Offsets
{
	constexpr int32 GObjects          = 0x079DFBB0;
	constexpr int32 AppendString      = 0x00C95AE0;
	constexpr int32 GNames            = 0x07939800;
	constexpr int32 GWorld            = 0x07B4CBE8;
	constexpr int32 ProcessEvent      = 0x00E51BC0;
