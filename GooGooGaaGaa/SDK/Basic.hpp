...
namespace Offsets
{
	constexpr int32 GObjects          = 0x088AAC30;
	constexpr int32 AppendString      = 0x010E34A0;
	constexpr int32 GNames            = 0x087F3EC0;
	constexpr int32 GWorld            = 0x08A2AC78;
	constexpr int32 ProcessEvent      = 0x012CF770;
