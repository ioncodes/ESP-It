...
public:
	...
	uint8                                         Pad_4DD1[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4DD3[0x6];                                     // 0x0022(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4DD4[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4DD5[0x6];                                     // 0x004A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	float                                         CallFunc_MakeRotator_Roll_ImplicitCast_1;          // 0x0214(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(B_Clock_C_RotateHands) == 0x000008, "Wrong alignment on B_Clock_C_RotateHands");
static_assert(sizeof(B_Clock_C_RotateHands) == 0x000218, "Wrong size on B_Clock_C_RotateHands");
...
static_assert(offsetof(B_Clock_C_RotateHands, CallFunc_K2_SetRelativeRotation_SweepHitResult_1) == 0x000128, "Member 'B_Clock_C_RotateHands::CallFunc_K2_SetRelativeRotation_SweepHitResult_1' has a wrong offset!");
static_assert(offsetof(B_Clock_C_RotateHands, CallFunc_MakeRotator_Roll_ImplicitCast) == 0x000210, "Member 'B_Clock_C_RotateHands::CallFunc_MakeRotator_Roll_ImplicitCast' has a wrong offset!");
static_assert(offsetof(B_Clock_C_RotateHands, CallFunc_MakeRotator_Roll_ImplicitCast_1) == 0x000214, "Member 'B_Clock_C_RotateHands::CallFunc_MakeRotator_Roll_ImplicitCast_1' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4DD6[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AGameStateBase*                         CallFunc_GetGameState_ReturnValue;                 // 0x0008(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4DD7[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4DD8[0x6];                                     // 0x0032(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4DD9[0x2];                                     // 0x0042(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
