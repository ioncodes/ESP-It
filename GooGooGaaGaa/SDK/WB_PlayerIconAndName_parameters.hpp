...
public:
	...
	bool                                          CallFunc_IsConsoleBuild_ReturnValue;               // 0x02C1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(WB_PlayerIconAndName_C_ExecuteUbergraph_WB_PlayerIconAndName, K2Node_CustomEvent_bSuccess) == 0x000004, "Member 'WB_PlayerIconAndName_C_ExecuteUbergraph_WB_PlayerIconAndName::K2Node_CustomEvent_bSuccess' has a wrong offset!");
...
static_assert(offsetof(WB_PlayerIconAndName_C_ExecuteUbergraph_WB_PlayerIconAndName, CallFunc_IsConsoleBuild_ReturnValue) == 0x0002C1, "Member 'WB_PlayerIconAndName_C_ExecuteUbergraph_WB_PlayerIconAndName::CallFunc_IsConsoleBuild_ReturnValue' has a wrong offset!");
