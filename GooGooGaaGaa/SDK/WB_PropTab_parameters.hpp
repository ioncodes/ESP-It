...
public:
	...
	uint8                                         Pad_47DB[0x2];                                     // 0x000E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47DC[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	ECheckBoxState                                CallFunc_GetCheckBoxState_CheckedState;            // 0x000C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_SwitchEnum_CmpSuccess;                      // 0x000D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_47DD[0x2];                                     // 0x000E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Temp_int_Array_Index_Variable_1;                   // 0x0010(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         Temp_int_Loop_Counter_Variable_1;                  // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AB_StaticMeshProp_C*                    CallFunc_Array_Get_Item;                           // 0x0018(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Add_IntInt_ReturnValue_1;                 // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                         Pad_47DF[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WB_PropTab_C_UpdateGravityButtonLabelText) == 0x000050, "Wrong size on WB_PropTab_C_UpdateGravityButtonLabelText");
...
static_assert(offsetof(WB_PropTab_C_UpdateGravityButtonLabelText, Temp_text_Variable_1) == 0x000020, "Member 'WB_PropTab_C_UpdateGravityButtonLabelText::Temp_text_Variable_1' has a wrong offset!");
static_assert(offsetof(WB_PropTab_C_UpdateGravityButtonLabelText, K2Node_Select_Default) == 0x000038, "Member 'WB_PropTab_C_UpdateGravityButtonLabelText::K2Node_Select_Default' has a wrong offset!");
...
public:
	...
	double                                        CallFunc_GetMaxHealth_MaxHealth;                   // 0x0070(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WB_PropTab_C_UpdatePropHpAndSpeedInfo) == 0x000108, "Wrong size on WB_PropTab_C_UpdatePropHpAndSpeedInfo");
...
static_assert(offsetof(WB_PropTab_C_UpdatePropHpAndSpeedInfo, K2Node_MakeArray_Array) == 0x000060, "Member 'WB_PropTab_C_UpdatePropHpAndSpeedInfo::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WB_PropTab_C_UpdatePropHpAndSpeedInfo, CallFunc_GetMaxHealth_MaxHealth) == 0x000070, "Member 'WB_PropTab_C_UpdatePropHpAndSpeedInfo::CallFunc_GetMaxHealth_MaxHealth' has a wrong offset!");
static_assert(offsetof(WB_PropTab_C_UpdatePropHpAndSpeedInfo, CallFunc_Format_ReturnValue) == 0x000078, "Member 'WB_PropTab_C_UpdatePropHpAndSpeedInfo::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_PropTab_C_UpdatePropHpAndSpeedInfo, K2Node_MakeStruct_FormatArgumentData_1) == 0x000090, "Member 'WB_PropTab_C_UpdatePropHpAndSpeedInfo::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(WB_PropTab_C_UpdatePropHpAndSpeedInfo, K2Node_MakeArray_Array_1) == 0x0000E0, "Member 'WB_PropTab_C_UpdatePropHpAndSpeedInfo::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(WB_PropTab_C_UpdatePropHpAndSpeedInfo, CallFunc_Format_ReturnValue_1) == 0x0000F0, "Member 'WB_PropTab_C_UpdatePropHpAndSpeedInfo::CallFunc_Format_ReturnValue_1' has a wrong offset!");
