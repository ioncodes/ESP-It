...
public:
	...
	class UStaticMeshComponent*                   Door;                                              // 0x0378(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class AB_IntDoor_C*                           RealActor;                                         // 0x0380(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_HunterBlockingPhysicalDoor_C) == 0x000388, "Wrong size on ABP_HunterBlockingPhysicalDoor_C");
static_assert(offsetof(ABP_HunterBlockingPhysicalDoor_C, Door) == 0x000378, "Member 'ABP_HunterBlockingPhysicalDoor_C::Door' has a wrong offset!");
static_assert(offsetof(ABP_HunterBlockingPhysicalDoor_C, RealActor) == 0x000380, "Member 'ABP_HunterBlockingPhysicalDoor_C::RealActor' has a wrong offset!");
