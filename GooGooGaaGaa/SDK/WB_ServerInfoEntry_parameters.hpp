...
static_assert(sizeof(WB_ServerInfoEntry_C_Get_ServerStatText_Text_0) == 0x000030, "Wrong size on WB_ServerInfoEntry_C_Get_ServerStatText_Text_0");
...
static_assert(offsetof(WB_ServerInfoEntry_C_Get_ServerStatText_Text_0, CallFunc_Conv_NameToText_ReturnValue) == 0x000018, "Member 'WB_ServerInfoEntry_C_Get_ServerStatText_Text_0::CallFunc_Conv_NameToText_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WB_ServerInfoEntry_C_Get_ServerValueText_Text_0) == 0x000030, "Wrong size on WB_ServerInfoEntry_C_Get_ServerValueText_Text_0");
...
static_assert(offsetof(WB_ServerInfoEntry_C_Get_ServerValueText_Text_0, CallFunc_Conv_StringToText_ReturnValue) == 0x000018, "Member 'WB_ServerInfoEntry_C_Get_ServerValueText_Text_0::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
