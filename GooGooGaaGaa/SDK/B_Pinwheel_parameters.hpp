...
public:
	...
	uint8                                         Pad_3144[0x7];                                     // 0x0079(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3145[0x7];                                     // 0x00D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FHitResult                             CallFunc_K2_AddRelativeRotation_SweepHitResult;    // 0x0140(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	uint8                                         Pad_3146[0x7];                                     // 0x0229(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          CallFunc_EqualEqual_VectorVector_ReturnValue_1;    // 0x0248(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3147[0x3];                                     // 0x0249(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_EqualEqual_VectorVector_ErrorTolerance_ImplicitCast; // 0x024C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_EqualEqual_VectorVector_ErrorTolerance_ImplicitCast_1; // 0x0250(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(B_Pinwheel_C_UpdatePinWheelRotation) == 0x000258, "Wrong size on B_Pinwheel_C_UpdatePinWheelRotation");
...
static_assert(offsetof(B_Pinwheel_C_UpdatePinWheelRotation, CallFunc_EqualEqual_VectorVector_ReturnValue) == 0x000228, "Member 'B_Pinwheel_C_UpdatePinWheelRotation::CallFunc_EqualEqual_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Pinwheel_C_UpdatePinWheelRotation, CallFunc_GetForwardVector_ReturnValue_1) == 0x000230, "Member 'B_Pinwheel_C_UpdatePinWheelRotation::CallFunc_GetForwardVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_Pinwheel_C_UpdatePinWheelRotation, CallFunc_EqualEqual_VectorVector_ReturnValue_1) == 0x000248, "Member 'B_Pinwheel_C_UpdatePinWheelRotation::CallFunc_EqualEqual_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_Pinwheel_C_UpdatePinWheelRotation, CallFunc_EqualEqual_VectorVector_ErrorTolerance_ImplicitCast) == 0x00024C, "Member 'B_Pinwheel_C_UpdatePinWheelRotation::CallFunc_EqualEqual_VectorVector_ErrorTolerance_ImplicitCast' has a wrong offset!");
static_assert(offsetof(B_Pinwheel_C_UpdatePinWheelRotation, CallFunc_EqualEqual_VectorVector_ErrorTolerance_ImplicitCast_1) == 0x000250, "Member 'B_Pinwheel_C_UpdatePinWheelRotation::CallFunc_EqualEqual_VectorVector_ErrorTolerance_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(B_Pinwheel_C_UpdatePinWheelRotation, CallFunc_MakeRotator_Roll_ImplicitCast) == 0x000254, "Member 'B_Pinwheel_C_UpdatePinWheelRotation::CallFunc_MakeRotator_Roll_ImplicitCast' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3148[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3149[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
