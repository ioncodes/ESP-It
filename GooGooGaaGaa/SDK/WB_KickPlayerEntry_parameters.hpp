...
public:
	...
	uint8                                         Pad_5AFE[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WB_KickPlayerEntry_C_Get_PlayerNameText_Text_0) == 0x000040, "Wrong size on WB_KickPlayerEntry_C_Get_PlayerNameText_Text_0");
...
static_assert(offsetof(WB_KickPlayerEntry_C_Get_PlayerNameText_Text_0, CallFunc_GetPlayerName_ReturnValue) == 0x000018, "Member 'WB_KickPlayerEntry_C_Get_PlayerNameText_Text_0::CallFunc_GetPlayerName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_KickPlayerEntry_C_Get_PlayerNameText_Text_0, CallFunc_Conv_StringToText_ReturnValue) == 0x000028, "Member 'WB_KickPlayerEntry_C_Get_PlayerNameText_Text_0::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
