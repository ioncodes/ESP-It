...
static_assert(offsetof(B_SeekGameState_C_HasTrackingStarted, Param_HasTrackingStarted_0) == 0x000000, "Member 'B_SeekGameState_C_HasTrackingStarted::Param_HasTrackingStarted_0' has a wrong offset!");
