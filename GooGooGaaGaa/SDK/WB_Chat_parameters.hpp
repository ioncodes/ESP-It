...
static_assert(sizeof(WB_Chat_C_CloseChat) == 0x000060, "Wrong size on WB_Chat_C_CloseChat");
...
static_assert(offsetof(WB_Chat_C_CloseChat, CallFunc_GetGameInstance_ReturnValue) == 0x000010, "Member 'WB_Chat_C_CloseChat::CallFunc_GetGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_Chat_C_CloseChat, K2Node_DynamicCast_AsB_Game_Instance) == 0x000018, "Member 'WB_Chat_C_CloseChat::K2Node_DynamicCast_AsB_Game_Instance' has a wrong offset!");
static_assert(offsetof(WB_Chat_C_CloseChat, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'WB_Chat_C_CloseChat::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WB_Chat_C_CloseChat, CallFunc_Array_Get_Item) == 0x000028, "Member 'WB_Chat_C_CloseChat::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WB_Chat_C_CloseChat, CallFunc_Array_Length_ReturnValue) == 0x000030, "Member 'WB_Chat_C_CloseChat::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_Chat_C_CloseChat, CallFunc_Less_IntInt_ReturnValue) == 0x000034, "Member 'WB_Chat_C_CloseChat::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_Chat_C_CloseChat, CallFunc_Array_Length_ReturnValue_1) == 0x000038, "Member 'WB_Chat_C_CloseChat::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WB_Chat_C_CloseChat, CallFunc_Subtract_IntInt_ReturnValue) == 0x00003C, "Member 'WB_Chat_C_CloseChat::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_Chat_C_CloseChat, CallFunc_Add_IntInt_ReturnValue_1) == 0x000040, "Member 'WB_Chat_C_CloseChat::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WB_Chat_C_CloseChat, CallFunc_Multiply_IntInt_ReturnValue) == 0x000044, "Member 'WB_Chat_C_CloseChat::CallFunc_Multiply_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_Chat_C_CloseChat, CallFunc_Conv_IntToDouble_ReturnValue) == 0x000048, "Member 'WB_Chat_C_CloseChat::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_Chat_C_CloseChat, CallFunc_PlayAnimation_ReturnValue) == 0x000050, "Member 'WB_Chat_C_CloseChat::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WB_Chat_C_SetupByGameState) == 0x000100, "Wrong size on WB_Chat_C_SetupByGameState");
...
static_assert(offsetof(WB_Chat_C_SetupByGameState, CallFunc_Add_DoubleDouble_ReturnValue) == 0x0000B0, "Member 'WB_Chat_C_SetupByGameState::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_Chat_C_SetupByGameState, CallFunc_MakeVector2D_ReturnValue_2) == 0x0000B8, "Member 'WB_Chat_C_SetupByGameState::CallFunc_MakeVector2D_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WB_Chat_C_SetupByGameState, K2Node_MakeStruct_WidgetTransform_1) == 0x0000C8, "Member 'WB_Chat_C_SetupByGameState::K2Node_MakeStruct_WidgetTransform_1' has a wrong offset!");
