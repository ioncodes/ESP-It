...
public:
	...
	double                                        Deceleration;                                      // 0x0078(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UB_FlyingEyeParameters_C) == 0x000088, "Wrong size on UB_FlyingEyeParameters_C");
static_assert(offsetof(UB_FlyingEyeParameters_C, ActivationManaCost) == 0x000058, "Member 'UB_FlyingEyeParameters_C::ActivationManaCost' has a wrong offset!");
static_assert(offsetof(UB_FlyingEyeParameters_C, ManaCostPerSecond) == 0x000060, "Member 'UB_FlyingEyeParameters_C::ManaCostPerSecond' has a wrong offset!");
static_assert(offsetof(UB_FlyingEyeParameters_C, MaxSpeed) == 0x000068, "Member 'UB_FlyingEyeParameters_C::MaxSpeed' has a wrong offset!");
static_assert(offsetof(UB_FlyingEyeParameters_C, Acceleration) == 0x000070, "Member 'UB_FlyingEyeParameters_C::Acceleration' has a wrong offset!");
static_assert(offsetof(UB_FlyingEyeParameters_C, Deceleration) == 0x000078, "Member 'UB_FlyingEyeParameters_C::Deceleration' has a wrong offset!");
static_assert(offsetof(UB_FlyingEyeParameters_C, Scale) == 0x000080, "Member 'UB_FlyingEyeParameters_C::Scale' has a wrong offset!");
