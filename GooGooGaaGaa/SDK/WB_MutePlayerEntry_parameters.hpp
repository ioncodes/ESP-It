...
public:
	...
	uint8                                         Pad_1D6[0x4];                                      // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D7[0x7];                                      // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D8[0x7];                                      // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D9[0x3];                                      // 0x0041(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class FText                                   CallFunc_GetMuteText_ReturnValue;                  // 0x0080(0x0018)()
};
...
static_assert(sizeof(WB_MutePlayerEntry_C_ExecuteUbergraph_WB_MutePlayerEntry) == 0x000098, "Wrong size on WB_MutePlayerEntry_C_ExecuteUbergraph_WB_MutePlayerEntry");
...
static_assert(sizeof(WB_MutePlayerEntry_C_Get_PlayerNameText_Text_0) == 0x000040, "Wrong size on WB_MutePlayerEntry_C_Get_PlayerNameText_Text_0");
...
static_assert(offsetof(WB_MutePlayerEntry_C_Get_PlayerNameText_Text_0, CallFunc_GetPlayerName_ReturnValue) == 0x000018, "Member 'WB_MutePlayerEntry_C_Get_PlayerNameText_Text_0::CallFunc_GetPlayerName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_MutePlayerEntry_C_Get_PlayerNameText_Text_0, CallFunc_Conv_StringToText_ReturnValue) == 0x000028, "Member 'WB_MutePlayerEntry_C_Get_PlayerNameText_Text_0::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1DA[0x4];                                      // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1DB[0x7];                                      // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1DC[0x7];                                      // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          CallFunc_IsPlayerMuted_IsMuted;                    // 0x0071(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1DD[0x6];                                      // 0x0072(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WB_MutePlayerEntry_C_GetMuteText) == 0x000090, "Wrong size on WB_MutePlayerEntry_C_GetMuteText");
...
static_assert(offsetof(WB_MutePlayerEntry_C_GetMuteText, Temp_text_Variable) == 0x000018, "Member 'WB_MutePlayerEntry_C_GetMuteText::Temp_text_Variable' has a wrong offset!");
static_assert(offsetof(WB_MutePlayerEntry_C_GetMuteText, CallFunc_GetGameInstance_ReturnValue) == 0x000030, "Member 'WB_MutePlayerEntry_C_GetMuteText::CallFunc_GetGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_MutePlayerEntry_C_GetMuteText, K2Node_DynamicCast_AsB_Game_Instance) == 0x000038, "Member 'WB_MutePlayerEntry_C_GetMuteText::K2Node_DynamicCast_AsB_Game_Instance' has a wrong offset!");
static_assert(offsetof(WB_MutePlayerEntry_C_GetMuteText, K2Node_DynamicCast_bSuccess) == 0x000040, "Member 'WB_MutePlayerEntry_C_GetMuteText::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WB_MutePlayerEntry_C_GetMuteText, Temp_text_Variable_1) == 0x000048, "Member 'WB_MutePlayerEntry_C_GetMuteText::Temp_text_Variable_1' has a wrong offset!");
static_assert(offsetof(WB_MutePlayerEntry_C_GetMuteText, Temp_bool_Variable) == 0x000060, "Member 'WB_MutePlayerEntry_C_GetMuteText::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WB_MutePlayerEntry_C_GetMuteText, K2Node_DynamicCast_AsB_Player_State) == 0x000068, "Member 'WB_MutePlayerEntry_C_GetMuteText::K2Node_DynamicCast_AsB_Player_State' has a wrong offset!");
static_assert(offsetof(WB_MutePlayerEntry_C_GetMuteText, K2Node_DynamicCast_bSuccess_1) == 0x000070, "Member 'WB_MutePlayerEntry_C_GetMuteText::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WB_MutePlayerEntry_C_GetMuteText, CallFunc_IsPlayerMuted_IsMuted) == 0x000071, "Member 'WB_MutePlayerEntry_C_GetMuteText::CallFunc_IsPlayerMuted_IsMuted' has a wrong offset!");
static_assert(offsetof(WB_MutePlayerEntry_C_GetMuteText, K2Node_Select_Default) == 0x000078, "Member 'WB_MutePlayerEntry_C_GetMuteText::K2Node_Select_Default' has a wrong offset!");
