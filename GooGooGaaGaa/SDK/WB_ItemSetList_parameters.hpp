...
public:
	...
	uint8                                         Pad_5EC8[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5EC9[0x3];                                     // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5ECA[0x7];                                     // 0x00B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_GetRarityInfo_Name;                       // 0x00B8(0x0018)()
	struct FLinearColor                           CallFunc_GetRarityInfo_Color;                      // 0x00D0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WB_ItemSetList_C_Get_SetNameField_ColorAndOpacity_0) == 0x0000F8, "Wrong size on WB_ItemSetList_C_Get_SetNameField_ColorAndOpacity_0");
...
static_assert(offsetof(WB_ItemSetList_C_Get_SetNameField_ColorAndOpacity_0, CallFunc_GetSkinItem_Found) == 0x0000B0, "Member 'WB_ItemSetList_C_Get_SetNameField_ColorAndOpacity_0::CallFunc_GetSkinItem_Found' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_Get_SetNameField_ColorAndOpacity_0, CallFunc_GetRarityInfo_Name) == 0x0000B8, "Member 'WB_ItemSetList_C_Get_SetNameField_ColorAndOpacity_0::CallFunc_GetRarityInfo_Name' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_Get_SetNameField_ColorAndOpacity_0, CallFunc_GetRarityInfo_Color) == 0x0000D0, "Member 'WB_ItemSetList_C_Get_SetNameField_ColorAndOpacity_0::CallFunc_GetRarityInfo_Color' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_Get_SetNameField_ColorAndOpacity_0, K2Node_MakeStruct_SlateColor) == 0x0000E0, "Member 'WB_ItemSetList_C_Get_SetNameField_ColorAndOpacity_0::K2Node_MakeStruct_SlateColor' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5ECB[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	class FText                                   Param_SetName;                                     // 0x0000(0x0018)(BlueprintVisible, BlueprintReadOnly, Parm)
	TArray<int32>                                 SortedIds;                                         // 0x0018(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	int32                                         Temp_int_Loop_Counter_Variable;                    // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Add_IntInt_ReturnValue;                   // 0x002C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         Temp_int_Array_Index_Variable;                     // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5ECC[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5ECD[0x3];                                     // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5ECE[0x4];                                     // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5ECF[0x6];                                     // 0x00DA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UB_SkinOrRecipeItemData_C*              CallFunc_GetSkinOrRecipeData_Data;                 // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WB_ItemSetList_C_UpdateSetList) == 0x000008, "Wrong alignment on WB_ItemSetList_C_UpdateSetList");
static_assert(sizeof(WB_ItemSetList_C_UpdateSetList) == 0x0000E8, "Wrong size on WB_ItemSetList_C_UpdateSetList");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, Param_SetName) == 0x000000, "Member 'WB_ItemSetList_C_UpdateSetList::Param_SetName' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, SortedIds) == 0x000018, "Member 'WB_ItemSetList_C_UpdateSetList::SortedIds' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, Temp_int_Loop_Counter_Variable) == 0x000028, "Member 'WB_ItemSetList_C_UpdateSetList::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, CallFunc_Add_IntInt_ReturnValue) == 0x00002C, "Member 'WB_ItemSetList_C_UpdateSetList::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, Temp_int_Array_Index_Variable) == 0x000030, "Member 'WB_ItemSetList_C_UpdateSetList::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, CallFunc_GetGameInstance_ReturnValue) == 0x000038, "Member 'WB_ItemSetList_C_UpdateSetList::CallFunc_GetGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, K2Node_DynamicCast_AsB_Game_Instance) == 0x000040, "Member 'WB_ItemSetList_C_UpdateSetList::K2Node_DynamicCast_AsB_Game_Instance' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, K2Node_DynamicCast_bSuccess) == 0x000048, "Member 'WB_ItemSetList_C_UpdateSetList::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, CallFunc_Array_Get_Item) == 0x00004C, "Member 'WB_ItemSetList_C_UpdateSetList::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, CallFunc_Array_Length_ReturnValue) == 0x000050, "Member 'WB_ItemSetList_C_UpdateSetList::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, CallFunc_GetSkinItem_ReturnValue) == 0x000058, "Member 'WB_ItemSetList_C_UpdateSetList::CallFunc_GetSkinItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, CallFunc_GetSkinItem_Found) == 0x0000D8, "Member 'WB_ItemSetList_C_UpdateSetList::CallFunc_GetSkinItem_Found' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, CallFunc_Less_IntInt_ReturnValue) == 0x0000D9, "Member 'WB_ItemSetList_C_UpdateSetList::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ItemSetList_C_UpdateSetList, CallFunc_GetSkinOrRecipeData_Data) == 0x0000E0, "Member 'WB_ItemSetList_C_UpdateSetList::CallFunc_GetSkinOrRecipeData_Data' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5ED0[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
