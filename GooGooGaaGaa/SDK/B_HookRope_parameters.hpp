...
public:
	...
	uint8                                         Pad_58FB[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_58FC[0x1];                                     // 0x000F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_58FD[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_58FE[0x7];                                     // 0x0141(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_58FF[0x7];                                     // 0x0181(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(B_HookRope_C_UpdateRopeTransform) == 0x0001C0, "Wrong size on B_HookRope_C_UpdateRopeTransform");
...
static_assert(offsetof(B_HookRope_C_UpdateRopeTransform, CallFunc_K2_SetActorLocation_ReturnValue) == 0x000140, "Member 'B_HookRope_C_UpdateRopeTransform::CallFunc_K2_SetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_HookRope_C_UpdateRopeTransform, CallFunc_Subtract_VectorVector_ReturnValue) == 0x000148, "Member 'B_HookRope_C_UpdateRopeTransform::CallFunc_Subtract_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_HookRope_C_UpdateRopeTransform, CallFunc_FindLookAtRotation_ReturnValue) == 0x000160, "Member 'B_HookRope_C_UpdateRopeTransform::CallFunc_FindLookAtRotation_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_HookRope_C_UpdateRopeTransform, CallFunc_VSize_ReturnValue) == 0x000178, "Member 'B_HookRope_C_UpdateRopeTransform::CallFunc_VSize_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_HookRope_C_UpdateRopeTransform, CallFunc_K2_SetActorRotation_ReturnValue) == 0x000180, "Member 'B_HookRope_C_UpdateRopeTransform::CallFunc_K2_SetActorRotation_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_HookRope_C_UpdateRopeTransform, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000188, "Member 'B_HookRope_C_UpdateRopeTransform::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_HookRope_C_UpdateRopeTransform, CallFunc_MakeVector_ReturnValue) == 0x000190, "Member 'B_HookRope_C_UpdateRopeTransform::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_HookRope_C_UpdateRopeTransform, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x0001A8, "Member 'B_HookRope_C_UpdateRopeTransform::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
