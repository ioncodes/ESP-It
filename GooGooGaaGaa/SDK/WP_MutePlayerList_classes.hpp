...
static_assert(sizeof(UWP_MutePlayerList_C) == 0x0002E0, "Wrong size on UWP_MutePlayerList_C");
static_assert(offsetof(UWP_MutePlayerList_C, UberGraphFrame) == 0x0002C0, "Member 'UWP_MutePlayerList_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWP_MutePlayerList_C, Back) == 0x0002C8, "Member 'UWP_MutePlayerList_C::Back' has a wrong offset!");
static_assert(offsetof(UWP_MutePlayerList_C, CanvasPanel_0) == 0x0002D0, "Member 'UWP_MutePlayerList_C::CanvasPanel_0' has a wrong offset!");
static_assert(offsetof(UWP_MutePlayerList_C, PlayerListScroll) == 0x0002D8, "Member 'UWP_MutePlayerList_C::PlayerListScroll' has a wrong offset!");
