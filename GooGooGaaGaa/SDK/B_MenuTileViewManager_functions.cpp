...
void UB_MenuTileViewManager_C::GetMaterialButtonData(class UUserWidget* Parent, bool IsInitial, class UMaterialInterface* Material, class UB_BasePlaceableMaterialOverwrite_C* MaterialOverwrite, int32 SlotIndex, class UB_MaterialButtonData_C** MaterialButtonData)
{
	static class UFunction* Func = nullptr;
