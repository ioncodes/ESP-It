...
static_assert(sizeof(B_StaticMeshProp_C_SetControlledByWitch) == 0x000048, "Wrong size on B_StaticMeshProp_C_SetControlledByWitch");
...
static_assert(sizeof(B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics) == 0x000048, "Wrong size on B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics");
...
static_assert(offsetof(B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics, CallFunc_GetOwner_ReturnValue) == 0x000008, "Member 'B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics, CallFunc_HasAuthority_ReturnValue) == 0x000010, "Member 'B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics, CallFunc_IsValid_ReturnValue) == 0x000011, "Member 'B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics, CallFunc_GetObjectClass_ReturnValue) == 0x000018, "Member 'B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics::CallFunc_GetObjectClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics, CallFunc_EqualEqual_ClassClass_ReturnValue) == 0x000020, "Member 'B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics::CallFunc_EqualEqual_ClassClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics, CallFunc_GetInstigator_ReturnValue) == 0x000028, "Member 'B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics::CallFunc_GetInstigator_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics, CallFunc_IsValid_ReturnValue_1) == 0x000030, "Member 'B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics, K2Node_DynamicCast_AsB_Prop_Pawn_Physics) == 0x000038, "Member 'B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics::K2Node_DynamicCast_AsB_Prop_Pawn_Physics' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics, K2Node_DynamicCast_bSuccess) == 0x000040, "Member 'B_StaticMeshProp_C_UpdateFadeAndVisualChildForPropPawnPhysics::K2Node_DynamicCast_bSuccess' has a wrong offset!");
...
static_assert(sizeof(B_StaticMeshProp_C_UpdateSleepWakeStatus) == 0x000070, "Wrong size on B_StaticMeshProp_C_UpdateSleepWakeStatus");
...
static_assert(offsetof(B_StaticMeshProp_C_UpdateSleepWakeStatus, CallFunc_GetTransform_ReturnValue) == 0x000010, "Member 'B_StaticMeshProp_C_UpdateSleepWakeStatus::CallFunc_GetTransform_ReturnValue' has a wrong offset!");
...
struct B_StaticMeshProp_C_HandleWakeServer final
{
public:
...
static_assert(alignof(B_StaticMeshProp_C_HandleWakeServer) == 0x000008, "Wrong alignment on B_StaticMeshProp_C_HandleWakeServer");
static_assert(sizeof(B_StaticMeshProp_C_HandleWakeServer) == 0x000018, "Wrong size on B_StaticMeshProp_C_HandleWakeServer");
static_assert(offsetof(B_StaticMeshProp_C_HandleWakeServer, CallFunc_GetGameState_ReturnValue) == 0x000000, "Member 'B_StaticMeshProp_C_HandleWakeServer::CallFunc_GetGameState_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_HandleWakeServer, K2Node_DynamicCast_AsB_Game_State) == 0x000008, "Member 'B_StaticMeshProp_C_HandleWakeServer::K2Node_DynamicCast_AsB_Game_State' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_HandleWakeServer, K2Node_DynamicCast_bSuccess) == 0x000010, "Member 'B_StaticMeshProp_C_HandleWakeServer::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_HandleWakeServer, CallFunc_IsValid_ReturnValue) == 0x000011, "Member 'B_StaticMeshProp_C_HandleWakeServer::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_HandleWakeServer, CallFunc_Not_PreBool_ReturnValue) == 0x000012, "Member 'B_StaticMeshProp_C_HandleWakeServer::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");

// Function B_StaticMeshProp.B_StaticMeshProp_C.HandleSleepServer
// 0x0020 (0x0020 - 0x0000)
struct B_StaticMeshProp_C_HandleSleepServer final
{
public:
	class AGameStateBase*                         CallFunc_GetGameState_ReturnValue;                 // 0x0000(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(B_StaticMeshProp_C_HandleSleepServer) == 0x000008, "Wrong alignment on B_StaticMeshProp_C_HandleSleepServer");
static_assert(sizeof(B_StaticMeshProp_C_HandleSleepServer) == 0x000020, "Wrong size on B_StaticMeshProp_C_HandleSleepServer");
static_assert(offsetof(B_StaticMeshProp_C_HandleSleepServer, CallFunc_GetGameState_ReturnValue) == 0x000000, "Member 'B_StaticMeshProp_C_HandleSleepServer::CallFunc_GetGameState_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_HandleSleepServer, CallFunc_IsUsingPropReplicationOptimization_ReturnValue) == 0x000008, "Member 'B_StaticMeshProp_C_HandleSleepServer::CallFunc_IsUsingPropReplicationOptimization_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_HandleSleepServer, K2Node_DynamicCast_AsB_Game_State) == 0x000010, "Member 'B_StaticMeshProp_C_HandleSleepServer::K2Node_DynamicCast_AsB_Game_State' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_HandleSleepServer, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'B_StaticMeshProp_C_HandleSleepServer::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_HandleSleepServer, CallFunc_IsValid_ReturnValue) == 0x000019, "Member 'B_StaticMeshProp_C_HandleSleepServer::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_HandleSleepServer, CallFunc_Not_PreBool_ReturnValue) == 0x00001A, "Member 'B_StaticMeshProp_C_HandleSleepServer::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_HandleSleepServer, CallFunc_Not_PreBool_ReturnValue_1) == 0x00001B, "Member 'B_StaticMeshProp_C_HandleSleepServer::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_HandleSleepServer, CallFunc_BooleanAND_ReturnValue) == 0x00001C, "Member 'B_StaticMeshProp_C_HandleSleepServer::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_HandleSleepServer, CallFunc_Not_PreBool_ReturnValue_2) == 0x00001D, "Member 'B_StaticMeshProp_C_HandleSleepServer::CallFunc_Not_PreBool_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(B_StaticMeshProp_C_HandleSleepServer, CallFunc_BooleanAND_ReturnValue_1) == 0x00001E, "Member 'B_StaticMeshProp_C_HandleSleepServer::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
