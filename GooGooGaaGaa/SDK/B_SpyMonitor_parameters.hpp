...
static_assert(sizeof(B_SpyMonitor_C_BndEvt__Highlight_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature) == 0x000118, "Wrong size on B_SpyMonitor_C_BndEvt__Highlight_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature");
...
public:
	...
	class UWB_SecurityCameraHud_C*                CallFunc_Create_ReturnValue;                       // 0x0178(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class APawn*                                  CallFunc_K2_GetPawn_ReturnValue;                   // 0x0180(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AB_ImpostorPlayerState_C*               K2Node_DynamicCast_AsB_Impostor_Player_State;      // 0x0188(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class APlayerController*                      CallFunc_GetFirstLocalPlayerController_ReturnValue_1; // 0x01A0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APlayerController*                      K2Node_CustomEvent_PlayerController_1;             // 0x01A8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APawn*                                  CallFunc_K2_GetPawn_ReturnValue_1;                 // 0x01B0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AB_ImpostorPlayerState_C*               K2Node_DynamicCast_AsB_Impostor_Player_State_1;    // 0x01B8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class AGameStateBase*                         CallFunc_GetGameState_ReturnValue;                 // 0x01C8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AB_ImpostorGameState_C*                 K2Node_DynamicCast_AsB_Impostor_Game_State;        // 0x01D0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_4;                     // 0x01D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsTickingCooldowns_TickingCooldowns;      // 0x01D9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class APlayerController*                      K2Node_CustomEvent_PlayerController;               // 0x01E0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor) == 0x0001F8, "Wrong size on B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor");
...
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_DynamicCast_AsPawn) == 0x000120, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_DynamicCast_AsPawn' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_DynamicCast_bSuccess) == 0x000128, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_IsLocallyControlled_ReturnValue) == 0x000129, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_IsLocallyControlled_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_ComponentBoundEvent_OverlappedComponent) == 0x000130, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_ComponentBoundEvent_OverlappedComponent' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_ComponentBoundEvent_OtherActor) == 0x000138, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_ComponentBoundEvent_OtherActor' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_ComponentBoundEvent_OtherComp) == 0x000140, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_ComponentBoundEvent_OtherComp' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_ComponentBoundEvent_OtherBodyIndex) == 0x000148, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_ComponentBoundEvent_OtherBodyIndex' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_DynamicCast_AsPawn_1) == 0x000150, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_DynamicCast_AsPawn_1' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_DynamicCast_bSuccess_1) == 0x000158, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_IsLocallyControlled_ReturnValue_1) == 0x000159, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_IsLocallyControlled_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_GetGameInstance_ReturnValue) == 0x000160, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_GetGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_GetFirstLocalPlayerController_ReturnValue) == 0x000168, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_GetFirstLocalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_Not_PreBool_ReturnValue) == 0x000170, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_Create_ReturnValue) == 0x000178, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_K2_GetPawn_ReturnValue) == 0x000180, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_K2_GetPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_DynamicCast_AsB_Impostor_Player_State) == 0x000188, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_DynamicCast_AsB_Impostor_Player_State' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_DynamicCast_bSuccess_2) == 0x000190, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_GetGameInstance_ReturnValue_1) == 0x000198, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_GetGameInstance_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_GetFirstLocalPlayerController_ReturnValue_1) == 0x0001A0, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_GetFirstLocalPlayerController_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_CustomEvent_PlayerController_1) == 0x0001A8, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_CustomEvent_PlayerController_1' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_K2_GetPawn_ReturnValue_1) == 0x0001B0, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_K2_GetPawn_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_DynamicCast_AsB_Impostor_Player_State_1) == 0x0001B8, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_DynamicCast_AsB_Impostor_Player_State_1' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_DynamicCast_bSuccess_3) == 0x0001C0, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_DynamicCast_bSuccess_3' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_HasAuthority_ReturnValue) == 0x0001C1, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_GetGameState_ReturnValue) == 0x0001C8, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_GetGameState_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_DynamicCast_AsB_Impostor_Game_State) == 0x0001D0, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_DynamicCast_AsB_Impostor_Game_State' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_DynamicCast_bSuccess_4) == 0x0001D8, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_DynamicCast_bSuccess_4' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_IsTickingCooldowns_TickingCooldowns) == 0x0001D9, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_IsTickingCooldowns_TickingCooldowns' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_BooleanAND_ReturnValue) == 0x0001DA, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_CustomEvent_PlayerController) == 0x0001E0, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_CustomEvent_PlayerController' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, CallFunc_K2_GetPawn_ReturnValue_2) == 0x0001E8, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::CallFunc_K2_GetPawn_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor, K2Node_Event_DeltaSeconds) == 0x0001F0, "Member 'B_SpyMonitor_C_ExecuteUbergraph_B_SpyMonitor::K2Node_Event_DeltaSeconds' has a wrong offset!");
...
static_assert(sizeof(B_SpyMonitor_C_GetTooltipText) == 0x000010, "Wrong size on B_SpyMonitor_C_GetTooltipText");
