...
static_assert(offsetof(B_PlayerState_C_ExecuteUbergraph_B_PlayerState, CallFunc_IsConsoleBuild_ReturnValue) == 0x000004, "Member 'B_PlayerState_C_ExecuteUbergraph_B_PlayerState::CallFunc_IsConsoleBuild_ReturnValue' has a wrong offset!");
