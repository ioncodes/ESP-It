...
public:
	...
	class FText                                   CallFunc_Get_Name_Text_0_ReturnValue;              // 0x00E0(0x0010)()
...
static_assert(offsetof(WB_TeamLogo_C_ExecuteUbergraph_WB_TeamLogo, K2Node_Event_IsDesignTime) == 0x0000F0, "Member 'WB_TeamLogo_C_ExecuteUbergraph_WB_TeamLogo::K2Node_Event_IsDesignTime' has a wrong offset!");
...
static_assert(sizeof(WB_TeamLogo_C_Get_Name_Text_0) == 0x000058, "Wrong size on WB_TeamLogo_C_Get_Name_Text_0");
...
static_assert(offsetof(WB_TeamLogo_C_Get_Name_Text_0, Temp_byte_Variable) == 0x000010, "Member 'WB_TeamLogo_C_Get_Name_Text_0::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WB_TeamLogo_C_Get_Name_Text_0, Temp_text_Variable) == 0x000018, "Member 'WB_TeamLogo_C_Get_Name_Text_0::Temp_text_Variable' has a wrong offset!");
static_assert(offsetof(WB_TeamLogo_C_Get_Name_Text_0, Temp_text_Variable_1) == 0x000028, "Member 'WB_TeamLogo_C_Get_Name_Text_0::Temp_text_Variable_1' has a wrong offset!");
static_assert(offsetof(WB_TeamLogo_C_Get_Name_Text_0, Temp_text_Variable_2) == 0x000038, "Member 'WB_TeamLogo_C_Get_Name_Text_0::Temp_text_Variable_2' has a wrong offset!");
static_assert(offsetof(WB_TeamLogo_C_Get_Name_Text_0, K2Node_Select_Default) == 0x000048, "Member 'WB_TeamLogo_C_Get_Name_Text_0::K2Node_Select_Default' has a wrong offset!");
