...
public:
	...
	void ExecuteUbergraph_WB_AchievementsScreen(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WB_AchievementsScreen_C">();
	}
	static class UWB_AchievementsScreen_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWB_AchievementsScreen_C>();
	}
};
