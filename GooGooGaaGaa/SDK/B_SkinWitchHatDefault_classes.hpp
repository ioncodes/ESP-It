...
static_assert(sizeof(AB_SkinWitchHatDefault_C) == 0x0002C0, "Wrong size on AB_SkinWitchHatDefault_C");
static_assert(offsetof(AB_SkinWitchHatDefault_C, SK_DefaultHat) == 0x0002B8, "Member 'AB_SkinWitchHatDefault_C::SK_DefaultHat' has a wrong offset!");
