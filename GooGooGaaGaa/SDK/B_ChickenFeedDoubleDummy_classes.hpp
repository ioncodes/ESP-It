...
{
public:
	class UStaticMeshComponent*                   UpperStraw;                                        // 0x0300(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AB_ChickenFeedDoubleDummy_C) == 0x000308, "Wrong size on AB_ChickenFeedDoubleDummy_C");
static_assert(offsetof(AB_ChickenFeedDoubleDummy_C, UpperStraw) == 0x000300, "Member 'AB_ChickenFeedDoubleDummy_C::UpperStraw' has a wrong offset!");
