...
{
public:
	bool                                          Activated;                                         // 0x0372(0x0001)(Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_ActionPlacable_C) == 0x000378, "Wrong size on ABP_ActionPlacable_C");
static_assert(offsetof(ABP_ActionPlacable_C, Activated) == 0x000372, "Member 'ABP_ActionPlacable_C::Activated' has a wrong offset!");
