...
static_assert(sizeof(WB_CreateTradeScreen_C_SortByAscii) == 0x000060, "Wrong size on WB_CreateTradeScreen_C_SortByAscii");
...
static_assert(offsetof(WB_CreateTradeScreen_C_SortByAscii, CallFunc_CompareStringsAlphabetically_AIsLessThanB) == 0x000058, "Member 'WB_CreateTradeScreen_C_SortByAscii::CallFunc_CompareStringsAlphabetically_AIsLessThanB' has a wrong offset!");
