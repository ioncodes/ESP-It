...
public:
	...
	uint8                                         Pad_54A4[0x6];                                     // 0x0092(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TMap<struct FUniqueNetIdRepl, bool>           PendingInvitations;                                // 0x00E0(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	...
	uint8                                         Pad_54A5[0x7];                                     // 0x0131(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GetIsFriendListRetrieved(bool* Param_FriendListRetrieved);
	void GetIsRecentPlayersRetrieved(bool* Param_RecentPlayersRetrieved);
	...
	void OnCallFailed_0905DDA04E51AF50B20F78A1FAAC3F6C(const struct FUniqueNetIdRepl& UserId, bool bWasSuccessful);
	...
	void OnPresenceTaskComplete_0905DDA04E51AF50B20F78A1FAAC3F6C(const struct FUniqueNetIdRepl& UserId, bool bWasSuccessful);
	...
	void SendFriendInvite(const struct FUniqueNetIdRepl& FriendId);
...
static_assert(sizeof(UB_FriendManager_C) == 0x000180, "Wrong size on UB_FriendManager_C");
