...
public:
	...
	uint8                                         Pad_335C[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_335D[0x1];                                     // 0x015B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_335E[0x4];                                     // 0x0164(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_335F[0x4];                                     // 0x01FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3360[0x7];                                     // 0x0231(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AB_AchievementTestVolume_C*             K2Node_DynamicCast_AsB_Achievement_Test_Volume;    // 0x0238(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0240(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3361[0x7];                                     // 0x0241(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(B_Camera_C_Test_For_AchievementTarget) == 0x000250, "Wrong size on B_Camera_C_Test_For_AchievementTarget");
...
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_LineTraceSingleForObjects_ReturnValue) == 0x000158, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_LineTraceSingleForObjects_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_bBlockingHit) == 0x000159, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_bInitialOverlap) == 0x00015A, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_Time) == 0x00015C, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_Distance) == 0x000160, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_Location) == 0x000168, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_ImpactPoint) == 0x000180, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_Normal) == 0x000198, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_ImpactNormal) == 0x0001B0, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_PhysMat) == 0x0001C8, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_PhysMat' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_HitActor) == 0x0001D0, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_HitActor' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_HitComponent) == 0x0001D8, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_HitComponent' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_HitBoneName) == 0x0001E0, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_HitBoneName' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_BoneName) == 0x0001E8, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_BoneName' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_HitItem) == 0x0001F0, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_HitItem' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_ElementIndex) == 0x0001F4, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_ElementIndex' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_FaceIndex) == 0x0001F8, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_FaceIndex' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_TraceStart) == 0x000200, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_TraceStart' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_BreakHitResult_TraceEnd) == 0x000218, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_BreakHitResult_TraceEnd' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x000230, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, K2Node_DynamicCast_AsB_Achievement_Test_Volume) == 0x000238, "Member 'B_Camera_C_Test_For_AchievementTarget::K2Node_DynamicCast_AsB_Achievement_Test_Volume' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, K2Node_DynamicCast_bSuccess) == 0x000240, "Member 'B_Camera_C_Test_For_AchievementTarget::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(B_Camera_C_Test_For_AchievementTarget, CallFunc_Greater_DoubleDouble_A_ImplicitCast) == 0x000248, "Member 'B_Camera_C_Test_For_AchievementTarget::CallFunc_Greater_DoubleDouble_A_ImplicitCast' has a wrong offset!");
