...
static_assert(sizeof(WB_TournamentScoreScreen_C_Get_Round_Text_0) == 0x000080, "Wrong size on WB_TournamentScoreScreen_C_Get_Round_Text_0");
...
static_assert(offsetof(WB_TournamentScoreScreen_C_Get_Round_Text_0, CallFunc_Conv_IntToInt64_ReturnValue) == 0x000010, "Member 'WB_TournamentScoreScreen_C_Get_Round_Text_0::CallFunc_Conv_IntToInt64_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TournamentScoreScreen_C_Get_Round_Text_0, K2Node_MakeStruct_FormatArgumentData) == 0x000018, "Member 'WB_TournamentScoreScreen_C_Get_Round_Text_0::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WB_TournamentScoreScreen_C_Get_Round_Text_0, K2Node_MakeArray_Array) == 0x000060, "Member 'WB_TournamentScoreScreen_C_Get_Round_Text_0::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WB_TournamentScoreScreen_C_Get_Round_Text_0, CallFunc_Format_ReturnValue) == 0x000070, "Member 'WB_TournamentScoreScreen_C_Get_Round_Text_0::CallFunc_Format_ReturnValue' has a wrong offset!");
