...
void AB_ImpostorSpectator_C::InpAxisEvt_Zoom_K2Node_InputAxisEvent_1(float AxisValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_ImpostorSpectator_C", "InpAxisEvt_Zoom_K2Node_InputAxisEvent_1");

	Params::B_ImpostorSpectator_C_InpAxisEvt_Zoom_K2Node_InputAxisEvent_1 Parms{};
