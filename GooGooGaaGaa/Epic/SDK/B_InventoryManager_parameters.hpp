...
public:
	...
	bool                                          CallFunc_WithEditor_ReturnValue_1;                 // 0x03C4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(TArray<struct FBlueprintOnlineItem>& Items)> K2Node_CreateDelegate_OutputDelegate_18;           // 0x03F4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(TArray<struct FBlueprintOnlineItem>& Items)> K2Node_CreateDelegate_OutputDelegate_19;           // 0x040C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetItemQuantity_ReturnValue;              // 0x041C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class APlayerController*                      CallFunc_GetFirstLocalPlayerController_ReturnValue_5; // 0x0438(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UGetAllItemsCallbackProxy*              CallFunc_ConsumeItem_ReturnValue;                  // 0x0440(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsValid_ReturnValue_8;                    // 0x0454(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_Greater_IntInt_ReturnValue_1;             // 0x045C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_45D[0x3];                                      // 0x045D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FBlueprintOnlineItem>           Temp_struct_Variable_9;                            // 0x0460(0x0010)(ReferenceParm)
	class UGetAllItemsCallbackProxy*              CallFunc_ExchangeItems_ReturnValue;                // 0x0470(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_9;                    // 0x0478(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Not_PreBool_ReturnValue_1;                // 0x0479(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UB_GameInstance_C*                      CallFunc_GetBGameInstance_ReturnValue;             // 0x0480(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FBlueprintOnlineItem                   CallFunc_Array_Get_Item;                           // 0x0488(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsConnectedTo_IsConnected;                // 0x0498(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager) == 0x0004A0, "Wrong size on B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager");
...
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_WithEditor_ReturnValue) == 0x000004, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_WithEditor_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_WithEditor_ReturnValue_1) == 0x0003C4, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_WithEditor_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, K2Node_CreateDelegate_OutputDelegate_18) == 0x0003F4, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::K2Node_CreateDelegate_OutputDelegate_18' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_Not_PreBool_ReturnValue) == 0x000404, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, K2Node_CreateDelegate_OutputDelegate_19) == 0x00040C, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::K2Node_CreateDelegate_OutputDelegate_19' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_GetItemQuantity_ReturnValue) == 0x00041C, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_GetItemQuantity_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_Array_Length_ReturnValue_1) == 0x000420, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_GetGameInstance_ReturnValue) == 0x000428, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_GetGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_Greater_IntInt_ReturnValue) == 0x000430, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_GetFirstLocalPlayerController_ReturnValue_5) == 0x000438, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_GetFirstLocalPlayerController_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_ConsumeItem_ReturnValue) == 0x000440, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_ConsumeItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, Temp_int_Loop_Counter_Variable) == 0x000448, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_Less_IntInt_ReturnValue) == 0x00044C, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_Add_IntInt_ReturnValue) == 0x000450, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_IsValid_ReturnValue_8) == 0x000454, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_IsValid_ReturnValue_8' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_Subtract_IntInt_ReturnValue) == 0x000458, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_Greater_IntInt_ReturnValue_1) == 0x00045C, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_Greater_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, Temp_struct_Variable_9) == 0x000460, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::Temp_struct_Variable_9' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_ExchangeItems_ReturnValue) == 0x000470, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_ExchangeItems_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_IsValid_ReturnValue_9) == 0x000478, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_IsValid_ReturnValue_9' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_Not_PreBool_ReturnValue_1) == 0x000479, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, Temp_int_Array_Index_Variable) == 0x00047C, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_GetBGameInstance_ReturnValue) == 0x000480, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_GetBGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_Array_Get_Item) == 0x000488, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_IsConnectedTo_IsConnected) == 0x000498, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_IsConnectedTo_IsConnected' has a wrong offset!");
static_assert(offsetof(B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager, CallFunc_BooleanOR_ReturnValue) == 0x000499, "Member 'B_InventoryManager_C_ExecuteUbergraph_B_InventoryManager::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
