...
// Class PropWitchHuntModule.FriendSubsystem
// 0x0000 (0x0030 - 0x0030)
class UFriendSubsystem final : public UGameInstanceSubsystem
{
public:
	void QueryPresenceForUsers(const struct FUniqueNetIdRepl& LocalUserId, const TArray<struct FUniqueNetIdRepl>& UserIds);
...
static_assert(sizeof(UFriendSubsystem) == 0x000030, "Wrong size on UFriendSubsystem");
...
public:
	...
	void OnGetSonyAccessTokenResponse(class UVaRestRequestJSON* Request);
	void OnJoinMatchResponse(class UVaRestRequestJSON* Request);
	void OnLeaveMatchResponse(class UVaRestRequestJSON* Request);
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MatchSubsystem">();
	}
	static class UMatchSubsystem* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMatchSubsystem>();
	}
};
...
public:
	...
	static void OpenStorePage(class UGameInstance* GameInstance, const TDelegate<void(bool PurchaseMade)>& Delegate);
...
// Class PropWitchHuntModule.ReplayWorldSubsystem
// 0x0000 (0x0030 - 0x0030)
class UReplayWorldSubsystem final : public UWorldSubsystem
{
public:
	void PlayReplay(const class FString& ReplayName);
	void StartRecordingReplay(const class FString& ReplayName, const class FString& FriendlyName);
	void StopRecordingReplay();

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"ReplayWorldSubsystem">();
	}
	static class UReplayWorldSubsystem* GetDefaultObj()
	{
		return GetDefaultObjImpl<UReplayWorldSubsystem>();
	}
};
...
public:
	...
	bool                                          IsSleeping;                                        // 0x0291(0x0001)(BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FTransform                             CurrentSleepTransform;                             // 0x0310(0x0060)(BlueprintVisible, Net, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	void OnRep_CurrentSleepTransform();
	void OnRep_IsSleeping();
	void OnReplicatedCurrentSleepTransform();
	void OnReplicatedIsSleeping();
...
static_assert(sizeof(UCreateUGCItemCallbackProxy) == 0x000048, "Wrong size on UCreateUGCItemCallbackProxy");
...
static_assert(sizeof(UUpdateUGCItemCallbackProxy) == 0x000058, "Wrong size on UUpdateUGCItemCallbackProxy");
...
// Class PropWitchHuntModule.WICharacterMovementComponent
// 0x0050 (0x0FE0 - 0x0F90)
class UWICharacterMovementComponent final : public UCharacterMovementComponent
{
public:
	uint8                                         Pad_F90[0x50];                                     // 0x0F90(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"WICharacterMovementComponent">();
	}
	static class UWICharacterMovementComponent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWICharacterMovementComponent>();
	}
};
static_assert(alignof(UWICharacterMovementComponent) == 0x000010, "Wrong alignment on UWICharacterMovementComponent");
static_assert(sizeof(UWICharacterMovementComponent) == 0x000FE0, "Wrong size on UWICharacterMovementComponent");
...
// Class PropWitchHuntModule.WitchItGameState
// 0x0000 (0x0308 - 0x0308)
class AWitchItGameState : public AGameState
{
public:
	float GetEngineMaxTickRate();
	void SetMaxNetTickRate(int32 NewValue);
	void SetNetServerMaxTickRate(int32 NewValue);

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"WitchItGameState">();
	}
	static class AWitchItGameState* GetDefaultObj()
	{
		return GetDefaultObjImpl<AWitchItGameState>();
	}
};
static_assert(alignof(AWitchItGameState) == 0x000008, "Wrong alignment on AWitchItGameState");
static_assert(sizeof(AWitchItGameState) == 0x000308, "Wrong size on AWitchItGameState");
...
{
public:
	void ApplyPropTransforms(const TArray<class AActor*>& RefList, const TArray<struct FVector3f>& Locations, const TArray<struct FVector3f>& Rotations);
	void GatherAndSendPropList();
	void PrintNetStats();
