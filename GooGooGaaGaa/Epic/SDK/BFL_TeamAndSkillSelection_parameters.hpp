...
// Function BFL_TeamAndSkillSelection.BFL_TeamAndSkillSelection_C.GetAllowedSkillsByGameRules
// 0x0058 (0x0058 - 0x0000)
struct BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules final
{
public:
	...
	TArray<class UClass*>                         AllowedSkills;                                     // 0x0018(0x0010)(Parm, OutParm)
	TArray<class UClass*>                         Skills;                                            // 0x0028(0x0010)(Edit, BlueprintVisible)
...
static_assert(alignof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules) == 0x000008, "Wrong alignment on BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules");
static_assert(sizeof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules) == 0x000058, "Wrong size on BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules");
static_assert(offsetof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules, PlayerTeam) == 0x000000, "Member 'BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules::PlayerTeam' has a wrong offset!");
static_assert(offsetof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules, GameState) == 0x000008, "Member 'BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules::GameState' has a wrong offset!");
static_assert(offsetof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules, __WorldContext) == 0x000010, "Member 'BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules::__WorldContext' has a wrong offset!");
static_assert(offsetof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules, AllowedSkills) == 0x000018, "Member 'BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules::AllowedSkills' has a wrong offset!");
static_assert(offsetof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules, Skills) == 0x000028, "Member 'BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules::Skills' has a wrong offset!");
static_assert(offsetof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules, Temp_int_Array_Index_Variable) == 0x000038, "Member 'BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules, Temp_int_Loop_Counter_Variable) == 0x00003C, "Member 'BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules, CallFunc_Add_IntInt_ReturnValue) == 0x000040, "Member 'BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules, CallFunc_Array_Get_Item) == 0x000048, "Member 'BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules, CallFunc_Array_Length_ReturnValue) == 0x000050, "Member 'BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules, CallFunc_Less_IntInt_ReturnValue) == 0x000054, "Member 'BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules, K2Node_SwitchEnum_CmpSuccess) == 0x000055, "Member 'BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules, CallFunc_Array_RemoveItem_ReturnValue) == 0x000056, "Member 'BFL_TeamAndSkillSelection_C_GetAllowedSkillsByGameRules::CallFunc_Array_RemoveItem_ReturnValue' has a wrong offset!");
