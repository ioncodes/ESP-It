...
public:
	...
	double                                        CallFunc_Handle_Mouse_Wheel_Axis_Axis_ImplicitCast; // 0x0228(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(WB_PlaceAndEditUI_C_OnMouseWheel, CallFunc_Handle_Mouse_Wheel_Axis_Axis_ImplicitCast) == 0x000228, "Member 'WB_PlaceAndEditUI_C_OnMouseWheel::CallFunc_Handle_Mouse_Wheel_Axis_Axis_ImplicitCast' has a wrong offset!");
