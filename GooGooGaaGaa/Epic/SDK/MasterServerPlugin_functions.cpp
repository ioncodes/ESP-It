...
// Function MasterServerPlugin.NewMasterServerManager.FetchAccountMessages
// (Final, Native, Public, BlueprintCallable)

void UNewMasterServerManager::FetchAccountMessages()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NewMasterServerManager", "FetchAccountMessages");
...
void UNewMasterServerManager::RequestAccountMessages(class UVaRestRequestJSON* Request)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NewMasterServerManager", "RequestAccountMessages");

	Params::NewMasterServerManager_RequestAccountMessages Parms{};
...
// Function MasterServerPlugin.NewMasterServerManager.SendRequestGameRewardsCheck
// (Final, Native, Public, BlueprintCallable)

void UNewMasterServerManager::SendRequestGameRewardsCheck()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NewMasterServerManager", "SendRequestGameRewardsCheck");
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// int64                                   UniqueID                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EAccountMessageState                    NewState                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UNewMasterServerManager::SetAccountMessageState(int64 UniqueID, EAccountMessageState NewState)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NewMasterServerManager", "SetAccountMessageState");

	Params::NewMasterServerManager_SetAccountMessageState Parms{};
