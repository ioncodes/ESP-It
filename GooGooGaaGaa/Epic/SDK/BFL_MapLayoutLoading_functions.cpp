...
void UBFL_MapLayoutLoading_C::SpawnStaticOrActionPlaceable(TScriptInterface<class IIMapLayoutLoading_C> Target, class UClass* Class_0, const struct FTransform& Transform, bool Activated, TArray<uint8>& MaterialIndices, class UObject* __WorldContext, class ABP_PlaceableStaticProp_C** SpawnedActor)
{
	static class UFunction* Func = nullptr;
