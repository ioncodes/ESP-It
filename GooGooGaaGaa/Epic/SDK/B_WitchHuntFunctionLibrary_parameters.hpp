...
static_assert(sizeof(B_WitchHuntFunctionLibrary_C_GetActorFromWitchAsPawn) == 0x000040, "Wrong size on B_WitchHuntFunctionLibrary_C_GetActorFromWitchAsPawn");
...
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_GetActorFromWitchAsPawn, CallFunc_GetObjectClass_ReturnValue) == 0x000030, "Member 'B_WitchHuntFunctionLibrary_C_GetActorFromWitchAsPawn::CallFunc_GetObjectClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_GetActorFromWitchAsPawn, CallFunc_EqualEqual_ClassClass_ReturnValue) == 0x000038, "Member 'B_WitchHuntFunctionLibrary_C_GetActorFromWitchAsPawn::CallFunc_EqualEqual_ClassClass_ReturnValue' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_ClassIsChildOf_ReturnValue_5;             // 0x0034(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_ClassIsChildOf_ReturnValue_6;             // 0x0035(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_BooleanOR_ReturnValue_4;                  // 0x003A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(B_WitchHuntFunctionLibrary_C_IsActorFromWitch) == 0x000040, "Wrong size on B_WitchHuntFunctionLibrary_C_IsActorFromWitch");
...
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_IsActorFromWitch, CallFunc_ClassIsChildOf_ReturnValue_5) == 0x000034, "Member 'B_WitchHuntFunctionLibrary_C_IsActorFromWitch::CallFunc_ClassIsChildOf_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_IsActorFromWitch, CallFunc_ClassIsChildOf_ReturnValue_6) == 0x000035, "Member 'B_WitchHuntFunctionLibrary_C_IsActorFromWitch::CallFunc_ClassIsChildOf_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_IsActorFromWitch, CallFunc_BooleanOR_ReturnValue) == 0x000036, "Member 'B_WitchHuntFunctionLibrary_C_IsActorFromWitch::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_IsActorFromWitch, CallFunc_BooleanOR_ReturnValue_1) == 0x000037, "Member 'B_WitchHuntFunctionLibrary_C_IsActorFromWitch::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_IsActorFromWitch, CallFunc_BooleanOR_ReturnValue_2) == 0x000038, "Member 'B_WitchHuntFunctionLibrary_C_IsActorFromWitch::CallFunc_BooleanOR_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_IsActorFromWitch, CallFunc_BooleanOR_ReturnValue_3) == 0x000039, "Member 'B_WitchHuntFunctionLibrary_C_IsActorFromWitch::CallFunc_BooleanOR_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_IsActorFromWitch, CallFunc_BooleanOR_ReturnValue_4) == 0x00003A, "Member 'B_WitchHuntFunctionLibrary_C_IsActorFromWitch::CallFunc_BooleanOR_ReturnValue_4' has a wrong offset!");
...
public:
	...
	bool                                          bIsInSlipperyWater;                                // 0x0008(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                __WorldContext;                                    // 0x0010(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UCharacterMovementComponent*            MovementComponent;                                 // 0x0018(0x0008)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UPhysicalMaterial*                      CallFunc_GetPhysicalMaterial_ReturnValue;          // 0x0108(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement) == 0x000118, "Wrong size on B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement");
...
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, bIsInSlipperyWater) == 0x000008, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::bIsInSlipperyWater' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, __WorldContext) == 0x000010, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::__WorldContext' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, MovementComponent) == 0x000018, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::MovementComponent' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_bBlockingHit) == 0x000020, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_bInitialOverlap) == 0x000021, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_Time) == 0x000024, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_Distance) == 0x000028, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_Location) == 0x000030, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_ImpactPoint) == 0x000048, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_Normal) == 0x000060, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_ImpactNormal) == 0x000078, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_PhysMat) == 0x000090, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_PhysMat' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_HitActor) == 0x000098, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_HitActor' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_HitComponent) == 0x0000A0, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_HitComponent' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_HitBoneName) == 0x0000A8, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_HitBoneName' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_BoneName) == 0x0000B0, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_BoneName' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_HitItem) == 0x0000B8, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_HitItem' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_ElementIndex) == 0x0000BC, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_ElementIndex' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_FaceIndex) == 0x0000C0, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_FaceIndex' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_TraceStart) == 0x0000C8, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_TraceStart' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_BreakHitResult_TraceEnd) == 0x0000E0, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_BreakHitResult_TraceEnd' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_GetMaterial_ReturnValue) == 0x0000F8, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_GetMaterial_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, CallFunc_GetPhysicalMaterial_ReturnValue) == 0x000108, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::CallFunc_GetPhysicalMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement, K2Node_SwitchEnum_CmpSuccess) == 0x000110, "Member 'B_WitchHuntFunctionLibrary_C_TickIceCharacterMovement::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
