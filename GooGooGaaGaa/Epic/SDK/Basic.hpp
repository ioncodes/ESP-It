...
namespace Offsets
{
	constexpr int32 GObjects          = 0x089689B0;
	constexpr int32 AppendString      = 0x010E5630;
	constexpr int32 GNames            = 0x088B1C40;
	constexpr int32 GWorld            = 0x08AE89F8;
	constexpr int32 ProcessEvent      = 0x012D18C0;
