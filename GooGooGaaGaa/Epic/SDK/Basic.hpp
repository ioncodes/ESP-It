...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08964530;
	constexpr int32 AppendString      = 0x010E54C0;
	constexpr int32 GNames            = 0x088AD7C0;
	constexpr int32 GWorld            = 0x08AE4578;
	constexpr int32 ProcessEvent      = 0x012D1850;
