...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08963530;
	constexpr int32 AppendString      = 0x010E5620;
	constexpr int32 GNames            = 0x088AC7C0;
	constexpr int32 GWorld            = 0x08AE3578;
	constexpr int32 ProcessEvent      = 0x012D19D0;
