...
class AB_Spectator_C : public APawn
{
public:
	...
	double                                        MovementSpeedMultiplier;                           // 0x0478(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        MaxMovementSpeedMulitplier;                        // 0x0480(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          bLimitUpDownToZ;                                   // 0x0488(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void SetTransformMulti(const struct FVector& Location, const struct FRotator& Rotation);
...
static_assert(offsetof(AB_Spectator_C, MovementSpeedMultiplier) == 0x000478, "Member 'AB_Spectator_C::MovementSpeedMultiplier' has a wrong offset!");
static_assert(offsetof(AB_Spectator_C, MaxMovementSpeedMulitplier) == 0x000480, "Member 'AB_Spectator_C::MaxMovementSpeedMulitplier' has a wrong offset!");
static_assert(offsetof(AB_Spectator_C, bLimitUpDownToZ) == 0x000488, "Member 'AB_Spectator_C::bLimitUpDownToZ' has a wrong offset!");
