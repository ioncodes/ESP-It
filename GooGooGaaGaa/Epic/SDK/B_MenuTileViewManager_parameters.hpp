...
public:
	...
	class UTexture2D*                             MaterialIcon;                                      // 0x0028(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UB_MaterialButtonData_C*                MaterialButtonData;                                // 0x0030(0x0008)(Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UB_MaterialButtonData_C*                ItemData;                                          // 0x0038(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UB_MaterialButtonData_C*                CallFunc_CreateObject_Object;                      // 0x0040(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(B_MenuTileViewManager_C_GetMaterialButtonData) == 0x000048, "Wrong size on B_MenuTileViewManager_C_GetMaterialButtonData");
...
static_assert(offsetof(B_MenuTileViewManager_C_GetMaterialButtonData, MaterialIcon) == 0x000028, "Member 'B_MenuTileViewManager_C_GetMaterialButtonData::MaterialIcon' has a wrong offset!");
static_assert(offsetof(B_MenuTileViewManager_C_GetMaterialButtonData, MaterialButtonData) == 0x000030, "Member 'B_MenuTileViewManager_C_GetMaterialButtonData::MaterialButtonData' has a wrong offset!");
static_assert(offsetof(B_MenuTileViewManager_C_GetMaterialButtonData, ItemData) == 0x000038, "Member 'B_MenuTileViewManager_C_GetMaterialButtonData::ItemData' has a wrong offset!");
static_assert(offsetof(B_MenuTileViewManager_C_GetMaterialButtonData, CallFunc_CreateObject_Object) == 0x000040, "Member 'B_MenuTileViewManager_C_GetMaterialButtonData::CallFunc_CreateObject_Object' has a wrong offset!");
