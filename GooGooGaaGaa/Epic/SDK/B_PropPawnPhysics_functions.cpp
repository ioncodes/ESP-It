...
void AB_PropPawnPhysics_C::RemoveAimAssistOnDedicatedServer()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_PropPawnPhysics_C", "RemoveAimAssistOnDedicatedServer");
...
// Function B_PropPawnPhysics.B_PropPawnPhysics_C.ClientUpdateControllerRotation
// (BlueprintCallable, BlueprintEvent)

void AB_PropPawnPhysics_C::ClientUpdateControllerRotation()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_PropPawnPhysics_C", "ClientUpdateControllerRotation");
