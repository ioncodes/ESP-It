...
public:
	...
	struct FUniqueNetIdRepl                       CallFunc_GetPlayerIdForMatch_NetId;                // 0x0008(0x0030)(HasGetValueTypeHash)
	bool                                          CallFunc_GetPlayerIdForMatch_IsPSNUser;            // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CallFunc_GetPlayerName_ReturnValue;                // 0x0040(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	struct FMatchPlayer                           K2Node_MakeStruct_MatchPlayer;                     // 0x0050(0x0058)()
	class AGameStateBase*                         CallFunc_GetGameState_ReturnValue;                 // 0x00A8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TArray<struct FMatchPlayer>                   K2Node_MakeArray_Array;                            // 0x00B0(0x0010)(ConstParm, ReferenceParm)
	...
	bool                                          CallFunc_HasRoundStarted_RoundHasStarted;          // 0x00C9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_CA[0x6];                                       // 0x00CA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class APawn*                                  CallFunc_GetPawn_ReturnValue;                      // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AB_Spectator_C*                         K2Node_DynamicCast_AsB_Spectator;                  // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UMatchSubsystem*                        CallFunc_GetGameInstanceSubsystem_ReturnValue;     // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class APawn*                                  CallFunc_SpawnNewPlayerPawn_PlayerPawn;            // 0x00F8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(B_SeekGameMode_C_MidgameJoiningPlayerReady) == 0x000110, "Wrong size on B_SeekGameMode_C_MidgameJoiningPlayerReady");
...
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, CallFunc_GetPlayerIdForMatch_NetId) == 0x000008, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::CallFunc_GetPlayerIdForMatch_NetId' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, CallFunc_GetPlayerIdForMatch_IsPSNUser) == 0x000038, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::CallFunc_GetPlayerIdForMatch_IsPSNUser' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, CallFunc_GetPlayerName_ReturnValue) == 0x000040, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::CallFunc_GetPlayerName_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, K2Node_MakeStruct_MatchPlayer) == 0x000050, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::K2Node_MakeStruct_MatchPlayer' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, CallFunc_GetGameState_ReturnValue) == 0x0000A8, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::CallFunc_GetGameState_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, K2Node_MakeArray_Array) == 0x0000B0, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, K2Node_DynamicCast_AsB_Game_State) == 0x0000C0, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::K2Node_DynamicCast_AsB_Game_State' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, K2Node_DynamicCast_bSuccess) == 0x0000C8, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, CallFunc_HasRoundStarted_RoundHasStarted) == 0x0000C9, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::CallFunc_HasRoundStarted_RoundHasStarted' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, CallFunc_GetPawn_ReturnValue) == 0x0000D0, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::CallFunc_GetPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, K2Node_DynamicCast_AsB_Spectator) == 0x0000D8, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::K2Node_DynamicCast_AsB_Spectator' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, K2Node_DynamicCast_bSuccess_1) == 0x0000E0, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, CallFunc_BooleanAND_ReturnValue) == 0x0000E1, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, CallFunc_GetGameInstanceSubsystem_ReturnValue) == 0x0000E8, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::CallFunc_GetGameInstanceSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, CallFunc_BooleanAND_ReturnValue_1) == 0x0000F0, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, CallFunc_SpawnNewPlayerPawn_PlayerPawn) == 0x0000F8, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::CallFunc_SpawnNewPlayerPawn_PlayerPawn' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, CallFunc_Now_ReturnValue) == 0x000100, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::CallFunc_Now_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_SeekGameMode_C_MidgameJoiningPlayerReady, CallFunc_GetGameTimeInSeconds_ReturnValue) == 0x000108, "Member 'B_SeekGameMode_C_MidgameJoiningPlayerReady::CallFunc_GetGameTimeInSeconds_ReturnValue' has a wrong offset!");
