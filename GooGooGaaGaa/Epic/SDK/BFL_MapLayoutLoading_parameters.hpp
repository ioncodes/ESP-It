...
public:
	...
	int32                                         CallFunc_Add_IntInt_ReturnValue;                   // 0x00A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_AC[0x4];                                       // 0x00AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPlaceableStaticToSave                 CallFunc_Array_Get_Item;                           // 0x00B0(0x0070)()
	...
	class ABP_PlaceableStaticProp_C*              CallFunc_SpawnStaticOrActionPlaceable_SpawnedActor; // 0x01C8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BFL_MapLayoutLoading_C_LoadStatics) == 0x000010, "Wrong alignment on BFL_MapLayoutLoading_C_LoadStatics");
static_assert(sizeof(BFL_MapLayoutLoading_C_LoadStatics) == 0x0001D0, "Wrong size on BFL_MapLayoutLoading_C_LoadStatics");
...
static_assert(offsetof(BFL_MapLayoutLoading_C_LoadStatics, CallFunc_Array_Length_ReturnValue) == 0x000120, "Member 'BFL_MapLayoutLoading_C_LoadStatics::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_LoadStatics, CallFunc_Less_IntInt_ReturnValue) == 0x000124, "Member 'BFL_MapLayoutLoading_C_LoadStatics::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_LoadStatics, CallFunc_MakeTransform_ReturnValue) == 0x000130, "Member 'BFL_MapLayoutLoading_C_LoadStatics::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_LoadStatics, CallFunc_GetSoftClassReferenceFromPrimaryAssetId_ReturnValue) == 0x000190, "Member 'BFL_MapLayoutLoading_C_LoadStatics::CallFunc_GetSoftClassReferenceFromPrimaryAssetId_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_LoadStatics, CallFunc_LoadClassAsset_Blocking_ReturnValue) == 0x0001B8, "Member 'BFL_MapLayoutLoading_C_LoadStatics::CallFunc_LoadClassAsset_Blocking_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_LoadStatics, CallFunc_Array_Add_ReturnValue) == 0x0001C0, "Member 'BFL_MapLayoutLoading_C_LoadStatics::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_LoadStatics, CallFunc_SpawnStaticOrActionPlaceable_SpawnedActor) == 0x0001C8, "Member 'BFL_MapLayoutLoading_C_LoadStatics::CallFunc_SpawnStaticOrActionPlaceable_SpawnedActor' has a wrong offset!");
...
public:
	...
	TArray<uint8>                                 MaterialIndices;                                   // 0x0088(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	...
	class ABP_PlaceableStaticProp_C*              SpawnedActor;                                      // 0x00A0(0x0008)(Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_A8[0x8];                                       // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             StaticsTransform;                                  // 0x00B0(0x0060)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ABP_PlaceableStaticProp_C*              SpawnedStatic;                                     // 0x0110(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	class UClass*                                 K2Node_ClassDynamicCast_AsBP_Action_Placable;      // 0x0118(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ABP_PlaceableStaticProp_C*              CallFunc_SpawnActionPlaceableStatic_SpawnedActor;  // 0x0200(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UClass*                                 K2Node_ClassDynamicCast_AsBP_Placeable_Static_Prop; // 0x0208(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_ClassDynamicCast_bSuccess_1;                // 0x0210(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_ClassIsChildOf_ReturnValue;               // 0x0211(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_ClassIsChildOf_ReturnValue_1;             // 0x0212(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_213[0x5];                                      // 0x0213(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class ABP_PlaceableStaticProp_C*              CallFunc_SpawnPlaceableStatic_SpawnedActor;        // 0x0218(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BooleanNOR_ReturnValue;                   // 0x0220(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable) == 0x000230, "Wrong size on BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable");
...
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, MaterialIndices) == 0x000088, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::MaterialIndices' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, __WorldContext) == 0x000098, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::__WorldContext' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, SpawnedActor) == 0x0000A0, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::SpawnedActor' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, StaticsTransform) == 0x0000B0, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::StaticsTransform' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, SpawnedStatic) == 0x000110, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::SpawnedStatic' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, K2Node_ClassDynamicCast_AsBP_Action_Placable) == 0x000118, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::K2Node_ClassDynamicCast_AsBP_Action_Placable' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, K2Node_ClassDynamicCast_bSuccess) == 0x000120, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::K2Node_ClassDynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, CallFunc_BreakTransform_Location) == 0x000128, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::CallFunc_BreakTransform_Location' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, CallFunc_BreakTransform_Rotation) == 0x000140, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::CallFunc_BreakTransform_Rotation' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, CallFunc_BreakTransform_Scale) == 0x000158, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::CallFunc_BreakTransform_Scale' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, CallFunc_BreakVector_X) == 0x000170, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::CallFunc_BreakVector_X' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, CallFunc_BreakVector_Y) == 0x000178, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::CallFunc_BreakVector_Y' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, CallFunc_BreakVector_Z) == 0x000180, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::CallFunc_BreakVector_Z' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, CallFunc_Conv_DoubleToVector_ReturnValue) == 0x000188, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::CallFunc_Conv_DoubleToVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, CallFunc_MakeTransform_ReturnValue) == 0x0001A0, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, CallFunc_SpawnActionPlaceableStatic_SpawnedActor) == 0x000200, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::CallFunc_SpawnActionPlaceableStatic_SpawnedActor' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, K2Node_ClassDynamicCast_AsBP_Placeable_Static_Prop) == 0x000208, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::K2Node_ClassDynamicCast_AsBP_Placeable_Static_Prop' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, K2Node_ClassDynamicCast_bSuccess_1) == 0x000210, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::K2Node_ClassDynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, CallFunc_ClassIsChildOf_ReturnValue) == 0x000211, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::CallFunc_ClassIsChildOf_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, CallFunc_ClassIsChildOf_ReturnValue_1) == 0x000212, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::CallFunc_ClassIsChildOf_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, CallFunc_SpawnPlaceableStatic_SpawnedActor) == 0x000218, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::CallFunc_SpawnPlaceableStatic_SpawnedActor' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable, CallFunc_BooleanNOR_ReturnValue) == 0x000220, "Member 'BFL_MapLayoutLoading_C_SpawnStaticOrActionPlaceable::CallFunc_BooleanNOR_ReturnValue' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_NotEqual_ClassClass_ReturnValue;          // 0x00C9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsActionActor_IsActionActor;              // 0x00D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FPlaceableStaticToSave                 K2Node_MakeStruct_PlaceableStaticToSave;           // 0x01A0(0x0070)()
	...
	class ABP_PlaceableStaticProp_C*              CallFunc_Array_Get_Item;                           // 0x0220(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BFL_MapLayoutLoading_C_StoreStatics) == 0x000230, "Wrong size on BFL_MapLayoutLoading_C_StoreStatics");
...
static_assert(offsetof(BFL_MapLayoutLoading_C_StoreStatics, Temp_int_Variable) == 0x0000C4, "Member 'BFL_MapLayoutLoading_C_StoreStatics::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_StoreStatics, CallFunc_ClassIsChildOf_ReturnValue) == 0x0000C8, "Member 'BFL_MapLayoutLoading_C_StoreStatics::CallFunc_ClassIsChildOf_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_StoreStatics, CallFunc_NotEqual_ClassClass_ReturnValue) == 0x0000C9, "Member 'BFL_MapLayoutLoading_C_StoreStatics::CallFunc_NotEqual_ClassClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_StoreStatics, CallFunc_Not_PreBool_ReturnValue) == 0x0000CA, "Member 'BFL_MapLayoutLoading_C_StoreStatics::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_StoreStatics, CallFunc_BooleanAND_ReturnValue) == 0x0000CB, "Member 'BFL_MapLayoutLoading_C_StoreStatics::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_StoreStatics, CallFunc_Add_IntInt_ReturnValue_1) == 0x0000CC, "Member 'BFL_MapLayoutLoading_C_StoreStatics::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_StoreStatics, CallFunc_IsActionActor_IsActionActor) == 0x0000D0, "Member 'BFL_MapLayoutLoading_C_StoreStatics::CallFunc_IsActionActor_IsActionActor' has a wrong offset!");
...
static_assert(offsetof(BFL_MapLayoutLoading_C_StoreStatics, CallFunc_GetObjectClass_ReturnValue) == 0x000210, "Member 'BFL_MapLayoutLoading_C_StoreStatics::CallFunc_GetObjectClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_StoreStatics, CallFunc_Array_Add_ReturnValue) == 0x000218, "Member 'BFL_MapLayoutLoading_C_StoreStatics::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_StoreStatics, CallFunc_Array_Get_Item) == 0x000220, "Member 'BFL_MapLayoutLoading_C_StoreStatics::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_StoreStatics, CallFunc_Array_Length_ReturnValue) == 0x000228, "Member 'BFL_MapLayoutLoading_C_StoreStatics::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BFL_MapLayoutLoading_C_StoreStatics, CallFunc_Less_IntInt_ReturnValue) == 0x00022C, "Member 'BFL_MapLayoutLoading_C_StoreStatics::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
