...
public:
	...
	bool                                          CallFunc_InRange_IntInt_ReturnValue;               // 0x007C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_7D[0x3];                                       // 0x007D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_Add_IntInt_ReturnValue;                   // 0x0080(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_84[0x4];                                       // 0x0084(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDateTime                              CallFunc_Array_Get_Item;                           // 0x0088(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_AreKillsInTimeRange_ReturnValue;          // 0x0091(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FDateTime                              CallFunc_Array_Get_Item_1;                         // 0x00B8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill) == 0x0000D0, "Wrong size on B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill");
...
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, Temp_int_Variable) == 0x000078, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, CallFunc_InRange_IntInt_ReturnValue) == 0x00007C, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::CallFunc_InRange_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, CallFunc_Add_IntInt_ReturnValue) == 0x000080, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, CallFunc_Array_Get_Item) == 0x000088, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, CallFunc_Array_IsValidIndex_ReturnValue) == 0x000090, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, CallFunc_AreKillsInTimeRange_ReturnValue) == 0x000091, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::CallFunc_AreKillsInTimeRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, Temp_int_Variable_1) == 0x000094, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::Temp_int_Variable_1' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, CallFunc_Conv_IntToText_ReturnValue) == 0x000098, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, CallFunc_LessEqual_IntInt_ReturnValue) == 0x0000A8, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, CallFunc_Add_IntInt_ReturnValue_1) == 0x0000AC, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, CallFunc_UtcNow_ReturnValue) == 0x0000B0, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::CallFunc_UtcNow_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, CallFunc_Array_Get_Item_1) == 0x0000B8, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, CallFunc_Array_Add_ReturnValue) == 0x0000C0, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, CallFunc_Array_Length_ReturnValue) == 0x0000C4, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill, CallFunc_Subtract_IntInt_ReturnValue_2) == 0x0000C8, "Member 'B_AnnouncerSystem_C_RegisterKillAndCheckForMultiKill::CallFunc_Subtract_IntInt_ReturnValue_2' has a wrong offset!");
...
public:
	...
	TDelegate<void(const class FString& LastWitchName)> K2Node_CreateDelegate_OutputDelegate;              // 0x0074(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_84[0x4];                                       // 0x0084(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 K2Node_CustomEvent_LastWitchName;                  // 0x0088(0x0010)(ZeroConstructor, HasGetValueTypeHash)
...
static_assert(sizeof(B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem) == 0x0000A0, "Wrong size on B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem");
...
static_assert(offsetof(B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem, K2Node_DynamicCast_AsB_Game_State) == 0x000068, "Member 'B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem::K2Node_DynamicCast_AsB_Game_State' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem, K2Node_DynamicCast_bSuccess_2) == 0x000070, "Member 'B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem, K2Node_CreateDelegate_OutputDelegate) == 0x000074, "Member 'B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem, K2Node_CustomEvent_LastWitchName) == 0x000088, "Member 'B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem::K2Node_CustomEvent_LastWitchName' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem, CallFunc_IsDedicatedServer_ReturnValue) == 0x000098, "Member 'B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem, CallFunc_Not_PreBool_ReturnValue) == 0x000099, "Member 'B_AnnouncerSystem_C_ExecuteUbergraph_B_AnnouncerSystem::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
